...
export declare class UserDataWriter<T = firestore.DocumentData> {
    ...
    constructor(firestore: Firestore, timestampsInSnapshots: boolean, serverTimestampBehavior?: "none" | "estimate" | "previous" | undefined, converter?: firestore.FirestoreDataConverter<T> | undefined);
