...
import { XhrIo as y, EventType as v, ErrorCode as m, createWebChannelTransport as g, WebChannel as E } from "@firebase/webchannel-wrapper";
 ...
 */
/** The semver (www.semver.org) version of the SDK. */ var w = i.SDK_VERSION, b = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
...
var I = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.A !== e) throw new T(I.ABORTED, "getToken aborted due to token change.");
            return n ? (Oe("string" == typeof n.accessToken), new N(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.m = function() {
        ...
        return Oe(null === t || "string" == typeof t), new b(t);
    }, t;
}(), S = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new S(this.P, this.V));
    }, t.prototype.l = function(t) {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new T(I.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new T(I.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new T(I.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new T(I.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
...
var R = /** @class */ function() {
    function t(t, e, n) {
        void 0 === e ? e = 0 : e > t.length && Le(), void 0 === n ? n = t.length - e : n > t.length - e && Le(), 
    ...
    return t(n, e), n.prototype.$ = function(t, e, r) {
        return new n(t, e, r);
    ...
    n.G = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new T(I.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var L = /^[_a-zA-Z][_a-zA-Z0-9]*$/, O = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.$ = function(t, e, r) {
    ...
    n.Z = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new T(I.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new T(I.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new T(I.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new T(I.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(R);

/** A dot-separated path for navigating sub-objects within a document. */ O.H = new O([]);
...
var C = /** @class */ function() {
    function t(t, e) {
        this.k = t, this.root = e || M.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.nt = function(e, n) {
        return new t(this.k, this.root.nt(e, n, this.k).rt(null, null, M.ht, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.k, this.root.remove(e, this.k).rt(null, null, M.ht, null, null));
    }, 
    ...
    t.prototype._t = function() {
        return new U(this.root, null, this.k, !1);
    }, t.prototype.lt = function(t) {
        return new U(this.root, t, this.k, !1);
    }, t.prototype.dt = function() {
        return new U(this.root, null, this.k, !0);
    }, t.prototype.ft = function(t) {
        return new U(this.root, t, this.k, !0);
    }, t;
}(), U = /** @class */ function() {
    function t(t, e, n, r) {
        this.Tt = r, this.Et = [];
    ...
    t.prototype.Dt = function() {
        if (this.Vt() && this.left.Vt()) throw Le();
        if (this.right.Vt()) throw Le();
        var t = this.left.Dt();
        if (t !== this.right.Dt()) throw Le();
...
M.EMPTY = null, M.RED = !0, M.ht = !1, 
// end LLRBEmptyNode
M.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var q = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Nt = function(t) {
        ...
        return new j(this.data._t());
    }, t.prototype.lt = function(t) {
        return new j(this.data.lt(t));
    }, 
...
var H = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);

/** Extracts the backend's type order for the provided value. */ function X(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Z(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : Le();
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function J(t, e) {
    var n = X(t);
    if (n !== X(e)) return !1;
    switch (n) {
      case 0 /* NullValue */ :
      ...
      case 9 /* ArrayValue */ :
        return Ue(t.arrayValue.values || [], e.arrayValue.values || [], J);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (F(n) !== F(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !J(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function tt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Ce(it(t.latitude), it(e.latitude));
            return 0 !== n ? n : Ce(it(t.longitude), it(e.longitude));
...
function et(t, e) {
    ...
    var n = rt(t), r = rt(e), i = Ce(n.seconds, r.seconds);
    return 0 !== i ? i : Ce(n.nanos, r.nanos);
}
...
function nt(t) {
    return function t(e) {
        ...
        }(e.timestampValue) : "stringValue" in e ? e.stringValue : "bytesValue" in e ? ot(e.bytesValue).toBase64() : "referenceValue" in e ? (r = e.referenceValue, 
        P.tt(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
 ...
 * limitations under the License.
 */
/** Transforms a value into a server-generated timestamp. */ var lt = /** @class */ function() {
    function t() {}
...
var pt = /** @class */ function() {
    ...
    return t.prototype.Bt = function(t, e) {
        ...
        return e instanceof t && Ue(this.elements, e.elements, J);
    }, t;
}(), dt = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    return t.prototype.Bt = function(t, e) {
        ...
        return ut(n) && ut(this.Qt) ? this.serializer.Wt(r) : this.serializer.jt(r);
    }, t.prototype.qt = function(t, e) {
        return e;
    }, 
    /**
    ...
    t.prototype.Ut = function(t) {
        ...
        return e instanceof t && J(this.Qt, e.Qt);
    }, t.prototype.asNumber = function(t) {
        return it(t.integerValue || t.doubleValue);
    }, t;
}();

/** Transforms an array value via a remove operation. */ function vt(t) {
...
e) {
    ...
    t.prototype.Yt = function(t) {
        return void 0 !== this.updateTime ? t instanceof xt && t.version.isEqual(this.updateTime) : void 0 === this.exists || this.exists === t instanceof xt;
    }, t.prototype.isEqual = function(t) {
        return this.exists === t.exists && (this.updateTime ? !!t.updateTime && this.updateTime.isEqual(t.updateTime) : !t.updateTime);
    }, t;
}();

/** A field path and the TransformOperation to perform upon it. */ wt.NONE = new wt;
...
var bt = /** @class */ function() {
     ...
     */
    t.Xt = function(t) {
        return t instanceof xt ? t.version : x.MIN;
    }, t;
}(), It = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.prototype.qt = function(t, e) {
        this.Jt(t);
        // Unlike applyToLocalView, if we're applying a mutation to a remote
        // document the server has accepted the mutation so the precondition must
        // have held.
        var n = e.version;
        return new xt(this.key, n, this.value, {
            hasCommittedMutations: !0
        });
    }, n.prototype.Bt = function(t, e, n) {
        if (this.Jt(t), !this.Zt.Yt(t)) return t;
        var r = bt.Xt(t);
        return new xt(this.key, r, this.value, {
            te: !0
        });
    ...
    return t(n, e), n.prototype.qt = function(t, e) {
        ...
        var n = this.ie(t);
        return new xt(this.key, e.version, n, {
            hasCommittedMutations: !0
        });
    }, n.prototype.Bt = function(t, e, n) {
        if (this.Jt(t), !this.Zt.Yt(t)) return t;
        var r = bt.Xt(t), i = this.ie(t);
        return new xt(this.key, r, i, {
            te: !0
        });
    }, n.prototype.ee = function(t) {
        return null;
    ...
    n.prototype.ie = function(t) {
        var e;
        return e = t instanceof xt ? t.data() : St.EMPTY, this.ne(e);
    ...
    return t(n, e), n.prototype.qt = function(t, e) {
        if (this.Jt(t), Oe(null != e.transformResults), !this.Zt.Yt(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
        ...
        return new xt(this.key, i, o, {
            hasCommittedMutations: !0
        });
    }, n.prototype.Bt = function(t, e, n) {
        if (this.Jt(t), !this.Zt.Yt(t)) return t;
        var r = this.oe(t), i = this.ce(n, t, e), o = this.ue(r.data(), i);
        return new xt(this.key, r.version, o, {
            te: !0
        });
    }, n.prototype.ee = function(t) {
        for (var e = null, n = 0, r = this.fieldTransforms; n < r.length; n++) {
            var i = r[n], o = t instanceof xt ? t.field(i.field) : void 0, s = i.transform.Ut(o || null);
            null != s && (e = null == e ? St._e().set(i.field, s) : e.set(i.field, s));
        }
        return e ? e.he() : null;
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.key.isEqual(t.key) && Ue(this.fieldTransforms, t.fieldTransforms, (function(t, e) {
            return t.isEqual(e);
    ...
    n.prototype.ae = function(t, e) {
        var n = [];
        Oe(this.fieldTransforms.length === e.length);
        for (var r = 0; r < e.length; r++) {
            var i = this.fieldTransforms[r], o = i.transform, s = null;
            t instanceof xt && (s = t.field(i.field)), n.push(o.qt(s, e[r]));
        }
        return n;
    }, 
    /**
    ...
    n.prototype.ce = function(t, e, n) {
        for (var r = [], i = 0, o = this.fieldTransforms; i < o.length; i++) {
            ...
            e instanceof xt && (a = e.field(s.field)), null === a && n instanceof xt && (
    ...
    return t(n, e), n.prototype.qt = function(t, e) {
        ...
        // document the server has accepted the mutation so the precondition must
        // have held.
        return this.Jt(t), new Rt(this.key, e.version, {
            hasCommittedMutations: !0
        });
    }, n.prototype.Bt = function(t, e, n) {
        return this.Jt(t), this.Zt.Yt(t) ? new Rt(this.key, x.S()) : t;
    }, n.prototype.ee = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.key.isEqual(t.key) && this.Zt.isEqual(t.Zt);
    }, n;
}(bt), At = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
    ...
    t.prototype.se = function() {
        ...
        var e = this, n = new q(O.k);
        return G(t.fields || {}, (function(t, r) {
            var i = new O([ t ]);
            if (10 /* ObjectValue */ === X(r)) {
...
var Dt = /** @class */ function() {
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.he = function() {
        var t = this.Ee(O.H, this.fe);
        return null != t ? new St(t) : this.de;
    }, 
    /**
    ...
    t.prototype.Ee = function(t, e) {
        var n = this, r = !1, i = this.de.field(t), o = ft(i) ? // If there is already data at the current path, base our
    ...
    return t.Ie = function(t, e) {
        return P.k(t.key, e.key);
    }, t;
}(), xt = /** @class */ function(e) {
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this, t, n) || this).we = r, o.te = !!i.te, o.hasCommittedMutations = !!i.hasCommittedMutations, 
        o;
    }
    return t(n, e), n.prototype.field = function(t) {
        ...
        return null !== r && null !== i ? tt(r, i) : Le();
    }, n;
    ...
    return t.prototype.canonicalId = function() {
        if (null === this.me) {
            ...
            t += this.filters.map((function(t) {
                ...
                return t.canonicalId();
            })).join(","), K(this.limit) || (t += "|l:", t += this.limit), this.startAt && (t += "|lb:", 
        ...
        K(this.limit) || (t += ", limit: " + this.limit), this.orderBy.length > 0 && (t += ", orderBy: [" + this.orderBy.join(", ") + "]"), 
        ...
        return P.st(this.path) && null === this.collectionGroup && 0 === this.filters.length;
    }, t;
}(), Ot = /** @class */ function() {
    /**
    ...
    return t.ve = function(e) {
        ...
        get: function() {
            if (null === this.pe) {
                ...
                t.J() ? this.pe = [ Qt ] : this.pe = [ new Yt(t), Qt ]; else {
                    this.pe = [];
                    ...
                    if (!n) {
                        ...
                        this.pe.push(s === Gt.ASCENDING ? Qt : Zt);
                    }
                }
            }
            return this.pe;
    ...
    t.prototype.canonicalId = function() {
        ...
        return !K(this.limit) && "F" /* First */ === this.ge;
    }, t.prototype.Ke = function() {
        return !K(this.limit) && "L" /* Last */ === this.ge;
    }, t.prototype.De = function() {
        return this.Ve.length > 0 ? this.Ve[0].field : null;
    }, t.prototype.Se = function() {
        for (var t = 0, e = this.filters; t < e.length; t++) {
            var n = e[t];
            if (n instanceof Ct && n.Ge()) return n.field;
        }
        return null;
    }, 
    ...
    t.prototype.ze = function(t) {
        for (var e = 0, n = this.filters; e < n.length; e++) {
            var r = n[e];
            if (r instanceof Ct && t.indexOf(r.op) >= 0) return r.op;
        }
        return null;
    }, t.prototype.Pe = function() {
        return this.xe().Pe();
    ...
    t.prototype.xe = function() {
        if (!this.ye) if ("F" /* First */ === this.ge) this.ye = new Lt(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
            // Flip the orderBy directions since we want the last results
            var t = [], e = 0, n = this.orderBy; e < n.length; e++) {
                var r = n[e], i = r.dir === Gt.DESCENDING ? Gt.ASCENDING : Gt.DESCENDING;
                t.push(new Yt(r.field, i));
            }
            // We need to swap the cursors to match the now-flipped query ordering.
                        var o = this.endAt ? new Kt(this.endAt.position, !this.endAt.before) : null, s = this.startAt ? new Kt(this.startAt.position, !this.startAt.before) : null;
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.et(this.collectionGroup) && this.path.U(e) : P.st(this.path) ? this.path.isEqual(e) : this.path.W(e);
    }, 
    /**
 ...
 */ Pt.LESS_THAN = new Pt("<"), Pt.LESS_THAN_OR_EQUAL = new Pt("<="), Pt.EQUAL = new Pt("=="), 
Pt.GREATER_THAN = new Pt(">"), Pt.GREATER_THAN_OR_EQUAL = new Pt(">="), Pt.ARRAY_CONTAINS = new Pt("array-contains"), 
Pt.IN = new Pt("in"), Pt.ARRAY_CONTAINS_ANY = new Pt("array-contains-any");

var Ct = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        if (t.J()) return e === Pt.IN ? new Mt(t, r) : new Ut(t, e, r);
        if (ht(r)) {
            if (e !== Pt.EQUAL) throw new T(I.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (ct(r)) {
            if (e !== Pt.EQUAL) throw new T(I.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return e === Pt.ARRAY_CONTAINS ? new qt(t, r) : e === Pt.IN ? new jt(t, r) : e === Pt.ARRAY_CONTAINS_ANY ? new Ft(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && X(this.value) === X(e) && this.Je(tt(e, this.value));
    }, n.prototype.Je = function(t) {
        switch (this.op) {
          case Pt.LESS_THAN:
            return t < 0;

          case Pt.LESS_THAN_OR_EQUAL:
            return t <= 0;

          case Pt.EQUAL:
            return 0 === t;

          case Pt.GREATER_THAN:
            return t > 0;

          case Pt.GREATER_THAN_OR_EQUAL:
            return t >= 0;
        ...
        return [ Pt.LESS_THAN, Pt.LESS_THAN_OR_EQUAL, Pt.GREATER_THAN, Pt.GREATER_THAN_OR_EQUAL ].indexOf(this.op) >= 0;
    }, n.prototype.canonicalId = function() {
        // TODO(b/29183165): Technically, this won't be unique if two values have
        // the same description, such as the int 3 and the string "3". So we should
        // add the types in here somehow, too.
        return this.field.K() + this.op.toString() + nt(this.value);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.op.isEqual(t.op) && this.field.isEqual(t.field) && J(this.value, t.value);
    }, n.prototype.toString = function() {
        return this.field.K() + " " + this.op + " " + nt(this.value);
    }, n;
}((function() {})), Ut = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = P.tt(r.referenceValue), i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = P.k(t.key, this.key);
        return this.Je(e);
    }, n;
}(Ct), Mt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, Pt.IN, n) || this).keys = (n.arrayValue.values || []).map((function(t) {
            return P.tt(t.referenceValue);
        })), r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(Ct), qt = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, Pt.ARRAY_CONTAINS, n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return at(e) && $(e.arrayValue, this.value);
    }, n;
}(Ct), jt = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, Pt.IN, n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return null !== e && $(this.value.arrayValue, e);
    }, n;
}(Ct), Ft = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, Pt.ARRAY_CONTAINS_ANY, n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = this, n = t.field(this.field);
        return !(!at(n) || !n.arrayValue.values) && n.arrayValue.values.some((function(t) {
            return $(e.value.arrayValue, t);
        }));
    }, n;
}(Ct), Gt = /** @class */ function() {
    function t(t) {
        this.name = t;
    }
...
var Bt, zt, Kt = /** @class */ function() {
    ...
    t.prototype.Ye = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.J() ? P.k(P.tt(o.referenceValue), e.key) : tt(o, e.field(i.field)), 
        ...
        for (var e = 0; e < this.position.length; e++) if (!J(this.position[e], t.position[e])) return !1;
        return !0;
    }, t;
}(), Yt = /** @class */ function() {
    function t(t, e) {
        this.field = t, void 0 === e && (e = Gt.ASCENDING), this.dir = e, this.Xe = t.J();
    }
    return t.prototype.compare = function(t, e) {
        var n = this.Xe ? xt.Ie(t, e) : xt.Ae(this.field, t, e);
        switch (this.dir) {
          case Gt.ASCENDING:
            return n;
...
}(), Qt = new Yt(O.X(), Gt.ASCENDING), Zt = new Yt(O.X(), Gt.DESCENDING), Wt = /** @class */ function() {
    function t(
     ...
     */ , s) {
        void 0 === i && (i = x.MIN), void 0 === o && (o = x.MIN), void 0 === s && (s = z.xt), 
 ...
 */ function Jt(t) {
    ...
    return Re("GRPC error has no .code"), I.UNKNOWN;
    switch (t) {
      case Bt.OK:
        return I.OK;
 ...
 *     Code.UNKNOWN.
 */ (zt = Bt || (Bt = {}))[zt.OK = 0] = "OK", zt[zt.CANCELLED = 1] = "CANCELLED", 
zt[zt.UNKNOWN = 2] = "UNKNOWN", zt[zt.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
zt[zt.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", zt[zt.NOT_FOUND = 5] = "NOT_FOUND", 
zt[zt.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", zt[zt.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
zt[zt.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", zt[zt.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
zt[zt.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", zt[zt.ABORTED = 10] = "ABORTED", 
zt[zt.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", zt[zt.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
zt[zt.INTERNAL = 13] = "INTERNAL", zt[zt.UNAVAILABLE = 14] = "UNAVAILABLE", zt[zt.DATA_LOSS = 15] = "DATA_LOSS";
...
function ue() {
    ...
    for (var n = se, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var ce = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.k = t ? function(e, n) {
            return t(e, n) || P.k(e.key, n.key);
        } : function(t, e) {
            return P.k(t.key, e.key);
        }, this.rs = re(), this.hs = new C(this.k)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, de.As(e, n)), new t(x.MIN, r, he(), te(), ue());
    }, t;
}(), de = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = z.xt), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.Ms = function() {
        ...
        })), new de(this.Ds, this.Cs, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.Ls = function() {
        this.Fs = !1, this.Ss = be();
    ...
    return t.prototype.zs = function(t) {
        for (var e = 0, n = t.ps; e < n.length; e++) {
            var r = n[e];
            t.ys instanceof xt ? this.Hs(r, t.ys) : t.ys instanceof Rt && this.Ys(r, t.key, t.ys);
        }
    ...
    t.prototype.si = function(t) {
        ...
        if (r) {
            ...
            if (i.Pe()) if (0 === n) {
                ...
                // queries.
                var o = new P(i.path);
                this.Ys(e, o, new Rt(o, x.S()));
            } else Oe(1 === n); else this.ni(e) !== n && (
    ...
    t.prototype.ri = function(t) {
        ...
        this.Ws.forEach((function(r, i) {
            ...
            if (o) {
                if (r.ms && o.target.Pe()) {
                    ...
                    var s = new P(o.target.path);
                    null !== e.js.get(s) || e.hi(i, s) || e.Ys(i, s, new Rt(s, t));
                }
        ...
        var i = new pe(t, n, this.Gs, this.js, r);
        return this.js = te(), this.Ks = we(), this.Gs = new q(Ce), i;
    }, 
    /**
    ...
    t.prototype.Bs = function(t) {
        ...
        var e = this.Ws.get(t);
        return e || (e = new ge, this.Ws.set(t, e)), e;
    }, t.prototype.oi = function(t) {
        var e = this.Ks.get(t);
        return e || (e = new q(Ce), this.Ks = this.Ks.nt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.ti = function(t) {
        ...
        return e || xe("WatchChangeAggregator", "Detected inactive target", t), e;
    }, 
    /**
    ...
    t.prototype.ei = function(t) {
        var e = this;
        this.Ws.set(t, new ge), this.Qs.ai(t).forEach((function(n) {
 ...
 */ var Ie = function() {
    ...
    var t = {};
    return t[Pt.LESS_THAN.name] = "LESS_THAN", t[Pt.LESS_THAN_OR_EQUAL.name] = "LESS_THAN_OR_EQUAL", 
    t[Pt.GREATER_THAN.name] = "GREATER_THAN", t[Pt.GREATER_THAN_OR_EQUAL.name] = "GREATER_THAN_OR_EQUAL", 
    t[Pt.EQUAL.name] = "EQUAL", t[Pt.ARRAY_CONTAINS.name] = "ARRAY_CONTAINS", t[Pt.IN.name] = "IN", 
    t[Pt.ARRAY_CONTAINS_ANY.name] = "ARRAY_CONTAINS_ANY", t;
}(), Ne = /** @class */ function() {
    function t(t, e) {
        this.ci = t, this.options = e;
    }
    return t.prototype._i = function(t) {
        var e = void 0 === t.code ? I.UNKNOWN : Jt(t.code);
     ...
     */
    t.prototype.Ii = function(t) {
        return this.options.di ? (Oe(void 0 === t || "string" == typeof t), z.fromBase64String(t || "")) : (Oe(void 0 === t || t instanceof Uint8Array), 
        z.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.F(t.F());
    }, t.prototype.fromVersion = function(t) {
        return Oe(!!t), x.v(this.v(t));
        ...
        var e = this.Ai(t);
        return Oe(e.get(1) === this.ci.projectId), Oe(!e.get(3) && !this.ci.database || e.get(3) === this.ci.database), 
        new P(this.Pi(e));
        ...
        return Oe(t.length > 4 && "documents" === t.get(4)), t.M(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.yi = function(t, e) {
        ...
        var n = this.tt(t.name), r = this.fromVersion(t.updateTime), i = new St({
            mapValue: {
                fields: t.fields
            }
        });
        ...
        Oe(!!t.found), t.found.name, t.found.updateTime;
        var e = this.tt(t.found.name), n = this.fromVersion(t.found.updateTime), r = new St({
            mapValue: {
        ...
        Oe(!!t.missing), Oe(!!t.readTime);
        var e = this.tt(t.missing), n = this.fromVersion(t.readTime);
        return new Rt(e, n);
    }, t.prototype.Ci = function(t) {
        return "found" in t ? this.Si(t) : "missing" in t ? this.Di(t) : Le();
    }, t.prototype.Fi = function(t) {
        var e;
        if ("targetChange" in t) {
            ...
            e = new me(n, r, i, s || null);
        } else if ("documentChange" in t) {
            t.documentChange;
            var u = t.documentChange;
            u.document, u.document.name, u.document.updateTime;
            var a = this.tt(u.document.name), h = this.fromVersion(u.document.updateTime), c = new St({
                mapValue: {
                    fields: u.document.fields
                }
            }), f = new xt(a, h, c, {}), l = u.targetIds || [], p = u.removedTargetIds || [];
            e = new ye(l, p, f.key, f);
        } else if ("documentDelete" in t) {
            t.documentDelete;
            var d = t.documentDelete;
            d.document;
            var y = this.tt(d.document), v = d.readTime ? this.fromVersion(d.readTime) : x.S(), m = new Rt(y, v), g = d.removedTargetIds || [];
            e = new ye([], g, m.key, m);
        } else if ("documentRemove" in t) {
            t.documentRemove;
            var E = t.documentRemove;
            E.document;
            var w = this.tt(E.document), b = E.removedTargetIds || [];
            e = new ye([], b, w, null);
        } else {
            if (!("filter" in t)) return Le();
            t.filter;
            var I = t.filter;
            I.targetId;
            var T = I.count || 0, N = new Ht(T), _ = I.targetId;
            e = new ve(_, N);
        }
        return e;
    }, t.prototype.Ni = function(t) {
        return "NO_CHANGE" === t ? 0 /* NoChange */ : "ADD" === t ? 1 /* Added */ : "REMOVE" === t ? 2 /* Removed */ : "CURRENT" === t ? 3 /* Current */ : "RESET" === t ? 4 /* Reset */ : Le();
        ...
        var e = this, n = t.currentDocument ? this.Bi(t.currentDocument) : wt.NONE;
        if (t.update) {
            t.update.name;
            var r = this.tt(t.update.name), i = new St({
                mapValue: {
        ...
        if (t.transform) {
            ...
            return Oe(!0 === n.exists), new Nt(u, a);
        }
        if (t.verify) {
        ...
        var n = this;
        return t && t.length > 0 ? (Oe(void 0 !== e), t.map((function(t) {
            return n.Qi(t, e);
        }))) : [];
    }, t.prototype.Li = function(t) {
        var e = t.transform;
        ...
        var e = null;
        if ("setToServerValue" in t) Oe("REQUEST_TIME" === t.setToServerValue), e = lt.instance; else if ("appendMissingElements" in t) {
            var n = t.appendMissingElements.values || [];
            e = new pt(n);
        } else if ("removeAllFromArray" in t) {
            var r = t.removeAllFromArray.values || [];
            e = new dt(r);
        } else "increment" in t ? e = new yt(this, t.increment) : Le();
        var i = O.Z(t.fieldPath);
        return new gt(i, e);
        ...
        Oe(1 === t.documents.length);
        var e = t.documents[0];
        return Ot.ve(this.gi(e)).xe();
    }, t.prototype.Gi = function(t) {
        ...
        var c = null;
        return n.endAt && (c = this.tn(n.endAt)), new Ot(e, i, u, s, a, "F" /* First */ , h, c).xe();
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof Ct ? e.in(t) : Le();
            }));
    ...
    t.prototype.cn = function(t) {
        ...
        switch (t) {
          ...
          case "GREATER_THAN_OR_EQUAL":
            return Pt.GREATER_THAN_OR_EQUAL;

          case "LESS_THAN":
            return Pt.LESS_THAN;

          case "LESS_THAN_OR_EQUAL":
            return Pt.LESS_THAN_OR_EQUAL;

          case "ARRAY_CONTAINS":
            return Pt.ARRAY_CONTAINS;

          case "IN":
            return Pt.IN;

          case "ARRAY_CONTAINS_ANY":
            return Pt.ARRAY_CONTAINS_ANY;
    ...
    t.prototype.hn = function(t) {
        ...
        return new Yt(this.dn(t.field), this.un(t.direction));
    }, t.prototype.rn = function(t) {
        return Ct.create(this.dn(t.fieldFilter.field), this._n(t.fieldFilter.op), t.fieldFilter.value);
    }, 
    // visible for testing
    t.prototype.in = function(t) {
        ...
        switch (t.unaryFilter.op) {
          case "IS_NAN":
            ...
            return Ct.create(e, Pt.EQUAL, {
                doubleValue: NaN
            });

          case "IS_NULL":
            var n = this.dn(t.unaryFilter.field);
            return Ct.create(n, Pt.EQUAL, {
 ...
 */ var Ae = /** @class */ function() {
    ...
    return t.fn = function(e) {
        t.platform && Le(), t.platform = e;
    }, t.Lt = function() {
        return t.platform || Le(), t.platform;
    }, t;
}(), Se = new o("@firebase/firestore");
...
function xe(t) {
    ...
    if (Se.logLevel <= s.DEBUG) {
        var i = e.map(Ve);
        Se.debug.apply(Se, r([ "Firestore (" + w + "): " + t ], i));
    }
}

function Re(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (Se.logLevel <= s.ERROR) {
        var i = e.map(Ve);
        Se.error.apply(Se, r([ "Firestore (" + w + "): " + t ], i));
    }
}
...
/** Helper to compare arrays using isEqual(). */ function Ue(t, e, n) {
...
function(t, e, n, r, i) {
    ...
    t.prototype.Pn = function(t) {
        ...
        return this.batchId === t.batchId && Ue(this.mutations, t.mutations, (function(t, e) {
            return t.isEqual(e);
        })) && Ue(this.baseMutations, t.baseMutations, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), Be = /** @class */ function() {
    ...
    return t.from = function(e, n, r, i) {
        Oe(e.mutations.length === r.length);
        for (var o = oe(), s = e.mutations, u = 0; u < s.length; u++) o = o.nt(s[u].key, r[u].version);
     ...
     */
    t.prototype.Nn = function(t) {
        var e = this, n = P.EMPTY, r = new Ke(n, t), i = new Ke(n, t + 1), o = [];
        ...
        var e = P.EMPTY, n = new Ke(e, t), r = new Ke(e, t + 1), i = ue();
        return this.yn.Ct([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Mn = function(t) {
        var e = new Ke(t, 0), n = this.pn.Nt(e);
    ...
    return t.Ie = function(t, e) {
        return P.k(t.key, e.key) || Ce(t.Ln, e.Ln);
    }, 
    /** Compare by ID then by key */ t.bn = function(t, e) {
        return Ce(t.Ln, e.Ln) || P.k(t.key, e.key);
    }, t;
}(), Ye = /** @class */ function() {
    function t(t) {
        var e = this;
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.qn && Le(), this.qn = !0, this.Bn ? this.error ? this.Un(n, this.error) : this.Qn(e, this.result) : new t((function(t, i) {
            r.On = function(n) {
                r.Qn(e, n).next(t, i);
            }, r.xn = function(e) {
                r.Un(n, e).next(t, i);
    ...
    t.prototype.tr = function(t, e) {
        this.Xn();
        var n = this.zn.get(e);
        return void 0 !== n ? Ye.resolve(n) : this.er(t, e);
    }, 
    /**
    ...
    t;
}(), Ze = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", We = /** @class */ function() {
    function t() {
        this.nr = [];
    }
    ...
    t.prototype.Er = function(t, e) {
        ...
        return this.ar.Ir(t, e).next((function(r) {
            var i = n.dr(t, e, r), o = te();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new Rt(t, x.S())), o = o.nt(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.wr = function(t, e, n) {
        ...
        return this.cr(t, new P(e)).next((function(t) {
            var e = re();
            return t instanceof xt && (e = e.nt(t.key, t)), e;
        }));
    }, t.prototype.Ar = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = re();
        return this.ur.Pr(t, i).next((function(s) {
            return Ye.forEach(s, (function(s) {
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.gr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof xt ? r.nt(h, f) : r.remove(h);
                }
            }));
        })).next((function() {
        ...
        for (var r = ue(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
            a instanceof Tt && null === n.get(a.key) && (r = r.add(a.key));
        }
        var h = n;
        return this.or.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof xt && (h = h.nt(t, e));
            })), h;
        }));
    }, t;
}(), Xe = /** @class */ function() {
    ...
    return t.br = function(e, n) {
        for (var r = ue(), i = ue(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
...
/** Represents the database ID a Firestore client is associated with. */ Je.Fr = -1;
...
var $e = function() {
    ...
    t.prototype.Ur = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && xe("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Or + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i) {
        this.jr = t, this.kr = e, this.Kr = n, this.op = r, this.Gr = i, this.zr = new $e, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.Yr && (this.clearTimeout(), this.zr.reject(new T(I.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.oh = new tn(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Eh = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.dh(), this.sh ? [ 3 /*break*/ , 2 ] : (this.sh = !0, (e = Ae.Lt().window) && e.removeEventListener("visibilitychange", this.ah), 
                    [ 4 /*yield*/ , this.Th(t) ]);
    ...
    t.prototype.Ih = function(t) {
                ...
                return e(r, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            return n.sent(), i.resolve(), this.oh.reset(), [ 3 /*break*/ , 3 ];

                          case 2:
                            if ("IndexedDbTransactionError" !== (e = n.sent()).name) throw i.resolve(), e;
                            // Failure will be handled by AsyncQueue
                                                        return xe("AsyncQueue", "Operation failed with retryable error: " + e), 
                            this.oh.Ur(o), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.th.then((function() {
            return e.rh = !0, t().catch((function(t) {
                ...
                throw e.nh = t, e.rh = !1, Re("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.rh = !1, t;
            }));
    ...
    t.prototype.Wr = function(t, e, n) {
        ...
        var i = en.Hr(this, t, e, n, (function(t) {
            return r.wh(t);
        }));
 ...
 */
function rn(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], s = Ce(n, i);
    return 0 === s ? Ce(r, o) : s;
}
 ...
 */ var on = /** @class */ function() {
    function t(t) {
        this.Vh = t, this.buffer = new q(rn), this.gh = 0;
    }
    return t.prototype.ph = function() {
        ...
        if (this.buffer.size < this.Vh) this.buffer = this.buffer.add(e); else {
            ...
            rn(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
...
un.Lh = -1, un.Oh = 1048576, un.xh = 41943040, un.$h = 10, un.Mh = 1e3, un.Bh = new un(un.xh, un.$h, un.Mh), 
un.DISABLED = new un(un.Lh, 0, 0);
...
var an = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        xe("LruGarbageCollector", "Garbage collection scheduled in " + n + "ms"), this.Qh = this.jr.Wr("lru_garbage_collection" /* LruGarbageCollection */ , n, (function() {
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.Jh = function(t, e) {
        var n = this;
        if (0 === e) return Ye.resolve(Je.Fr);
        var r = new on(e);
    ...
    t.prototype.to = function(t, e) {
        ...
        var n = this;
        return this.Wh.Ch === un.Lh ? (xe("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Ye.resolve(sn)) : this.so(t).next((function(r) {
            return r < n.Wh.Ch ? (xe("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.Wh.Ch), 
            sn) : n.io(t, e);
        }));
        ...
        return this.Hh(t, this.Wh.Fh).next((function(e) {
            ...
            return e > c.Wh.Nh ? (xe("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.Wh.Nh + " from " + e), 
            r = c.Wh.Nh) : r = e, o = Date.now(), c.Jh(t, r);
        })).next((function(r) {
            return n = r, u = Date.now(), c.Zh(t, n, e);
        })).next((function(e) {
            return i = e, a = Date.now(), c.to(t, n);
        })).next((function(t) {
            return h = Date.now(), De() <= s.DEBUG && xe("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (u - o) + "ms\n\tRemoved " + i + " targets in " + (a - u) + "ms\n\tRemoved " + t + " documents in " + (h - a) + "ms\nTotal Duration: " + (h - f) + "ms"), 
            Ye.resolve({
                bh: !0,
                vh: r,
                Sh: i,
 ...
 */
function cn(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = ln(e)), e = fn(t.get(n), e);
    return ln(e);
}

/** Encodes a single segment of a resource path into the given result */ function fn(t, e) {
...
/** Encodes a path separator into the given result */ function ln(t) {
    return t + "";
}
 ...
 */ function pn(t) {
    ...
    var e = t.length;
    if (Oe(e >= 2), 2 === e) return Oe("" === t.charAt(0) && "" === t.charAt(1)), 
    V.H;
    ...
    // source value.
        ...
        var s = t.indexOf("", o);
        switch ((s < 0 || s > n) && Le(), t.charAt(s + 1)) {
          case "":
 ...
 */ var dn = /** @class */ function() {
    function t(e) {
        ...
        // log on 12.2.
        12.2 === t.no(u()) && Re("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")
        /**
    ...
    return t.ro = function(e, n, r) {
        return xe("SimpleDb", "Opening database:", e), new Ye((function(i, o) {
            ...
            s.onsuccess = function(e) {
                ...
                o(new T(I.FAILED_PRECONDITION, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, s.onerror = function(t) {
                var e = t.target.error;
                "VersionError" === e.name ? o(new T(I.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : o(e);
            }, s.onupgradeneeded = function(t) {
                xe("SimpleDb", 'Database "' + e + '" requires upgrade from version:', t.oldVersion);
                var n = t.target.result;
                r.createOrUpgrade(n, s.transaction, t.oldVersion, Fn).next((function() {
                    xe("SimpleDb", "Database upgrade to version " + Fn + " complete");
                }));
            };
        })).Wn();
    }, 
    /** Deletes the specified database. */ t.delete = function(t) {
        return xe("SimpleDb", "Removing database:", t), En(window.indexedDB.deleteDatabase(t)).Wn();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.ho = function() {
        ...
        // Check the UA string to find out the browser.
                var e = u(), n = t.no(e), r = 0 < n && n < 10, i = t.ao(e), o = 0 < i && i < 4.5;
        // IE 10
                  ...
                  case 0:
                    e = "readonly" === t, o = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                ++o, t = mn.open(u.db, e ? "readonly" : "readwrite", r), n.label = 1;
                              ...
                              case 3:
                                return h = n.sent(), c = "FirebaseError" !== h.name && o < 3, xe("SimpleDb", "Transaction failed with error: %s. Retrying: %s.", h.message, c), 
    ...
    t.prototype.delete = function() {
        return En(this.do.delete());
    }, t;
}(), vn = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this, I.UNAVAILABLE, "IndexedDB transaction failed: " + t) || this).name = "IndexedDbTransactionError", 
        n;
    }
    return t(n, e), n;
}(T), mn = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             */
        this.wo = new $e, this.transaction.oncomplete = function() {
            e.wo.resolve();
        }, this.transaction.onabort = function() {
            t.error ? e.wo.reject(new vn(t.error)) : e.wo.resolve();
        }, this.transaction.onerror = function(t) {
            var n = bn(t.target.error);
            e.wo.reject(new vn(n));
        };
    }
    return t.open = function(e, n, r) {
        ...
        t && this.wo.reject(t), this.aborted || (xe("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    return t.prototype.put = function(t, e) {
        var n;
        return void 0 !== e ? (xe("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (xe("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
    ...
    t.prototype.add = function(t) {
        return xe("SimpleDb", "ADD", this.store.name, t, t), En(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            return void 0 === n && (n = null), xe("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return xe("SimpleDb", "DELETE", this.store.name, t), En(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return xe("SimpleDb", "COUNT", this.store.name), En(this.store.count());
        ...
        xe("SimpleDb", "DELETE ALL", this.store.name);
    ...
    t.prototype.po = function(t) {
        ...
        var n = [];
        return new Ye((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new yn(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof Ye) {
                        var u = s.catch((function(t) {
                            return o.done(), Ye.reject(t);
                        }));
                        n.push(u);
                    }
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ var In = /** @class */ function() {
    function t(
    /**
    ...
    return t.vo = function(e, n, r, i) {
        ...
        return Oe("" !== e.uid), new t(e.t() ? e.uid : "", n, r, i);
    }, t.prototype.So = function(t) {
        var e = !0, n = IDBKeyRange.bound([ this.userId, Number.NEGATIVE_INFINITY ], [ this.userId, Number.POSITIVE_INFINITY ]);
        return _n(t).Vo({
            index: Yn.userMutationsIndex,
            range: n
        }, (function(t, n, r) {
            e = !1, r.done();
        })).next((function() {
        ...
        return this.Co(t).next((function(e) {
            ...
            return e.lastStreamToken = n.toBase64(), Sn(t).put(e);
        }));
    }, t.prototype.Fo = function(t) {
        return this.Co(t).next((function(t) {
            return z.fromBase64String(t.lastStreamToken);
        }));
    }, t.prototype.No = function(t, e) {
        return this.Co(t).next((function(n) {
            // We can't store the resumeToken as a ByteString in IndexedDB, so we
            // convert it to a Base64 string for storage.
            return n.lastStreamToken = e.toBase64(), Sn(t).put(n);
        }));
    }, t.prototype.ko = function(t, e, n, r) {
        var i = this, o = An(t), s = _n(t);
        ...
        return s.add({}).next((function(u) {
            Oe("number" == typeof u);
            for (var a = new Ge(u, e, n, r), h = i.serializer.$o(i.userId, a), c = [], f = new q((function(t, e) {
                return Ce(t.K(), e.K());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], y = Qn.key(i.userId, d.key.path, u);
                f = f.add(d.key.path.L()), c.push(s.put(h)), c.push(o.put(y, Qn.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                c.push(i.ur.Mo(t, e));
            })), t.rr((function() {
                i.bo[u] = a.keys();
            })), Ye.Kn(c).next((function() {
                return a;
            }));
        }));
        ...
        return _n(t).get(e).next((function(t) {
            return t ? (Oe(t.userId === n.userId), n.serializer.Oo(t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.xo = function(t, e) {
        var n = this;
        return this.bo[e] ? Ye.resolve(this.bo[e]) : this.Lo(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.bo[e] = r, r;
            }
        ...
        return _n(t).Vo({
            ...
            e.userId === n.userId && (Oe(e.batchId >= r), o = n.serializer.Oo(e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return _n(t).Ro(Yn.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return e.serializer.Oo(t);
            }));
        }));
    }, t.prototype._r = function(t, e) {
        var n = this, r = Qn.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return An(t).Vo({
            range: i
        }, (function(r, i, s) {
            var u = r[0], a = r[1], h = r[2], c = pn(a);
            ...
            return _n(t).get(h).next((function(t) {
                if (!t) throw Le();
                Oe(t.userId === n.userId), o.push(n.serializer.Oo(t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new q(Ce), i = [];
        return e.forEach((function(e) {
            var o = Qn.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = An(t).Vo({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], h = pn(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), Ye.Kn(i).next((function() {
            return n.Qo(t, r);
        }));
    }, t.prototype.Vr = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Qn.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new q(Ce);
        return An(t).Vo({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], h = t[2], c = pn(a);
            s === n.userId && r.U(c) ? 
        ...
        return e.forEach((function(e) {
            i.push(_n(t).get(e).next((function(t) {
                if (null === t) throw Le();
                Oe(t.userId === n.userId), r.push(n.serializer.Oo(t));
            })));
        })), Ye.Kn(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Nn(t.jo, this.userId, e).next((function(r) {
            return t.rr((function() {
                n.Ko(e.batchId);
            })), Ye.forEach(r, (function(e) {
                return n.yo.Go(t, e);
            }));
        }));
    }, 
    ...
    t.prototype.Ko = function(t) {
        ...
        return this.So(t).next((function(n) {
            if (!n) return Ye.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(Qn.prefixForUser(e.userId)), i = [];
            return An(t).Vo({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
        ...
        return Tn(t, this.userId, e);
    }, 
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    t.prototype.Co = function(t) {
        var e = this;
        return Sn(t).get(this.userId).next((function(t) {
 ...
 */ function Tn(t, e, n) {
    var r = Qn.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return An(t).Vo({
        range: o,
        Po: !0
    }, (function(t, n, r) {
 ...
 */ function Nn(t, e, n) {
    var r = t.store(Yn.store), i = t.store(Qn.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Vo({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var h = [], c = 0, f = n.mutations; c < f.length; c++) {
        var l = f[c], p = Qn.key(e, l.key.path, n.batchId);
        o.push(i.delete(p)), h.push(l.key);
    }
    return Ye.Kn(o).next((function() {
        return h;
    }));
}
 ...
 */ function _n(t) {
    return cr.co(t, Yn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function An(t) {
    return cr.co(t, Qn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Sn(t) {
    return cr.co(t, Kn.store);
}
 ...
 */ var Dn = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Zo(t).next((function(n) {
            var r = new Dn(n.highestTargetId);
        ...
        return this.Zo(t).next((function(t) {
            return x.v(new k(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.ua(t, e.targetId).next((function() {
            return xn(t).delete(e.targetId);
        })).next((function() {
            return n.Zo(t);
        })).next((function(e) {
            return Oe(e.targetCount > 0), e.targetCount -= 1, n.ta(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.Xs = function(t, e) {
        ...
        return (n = t, cr.co(n, tr.store)).put(tr.key, e);
        /**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */        var n;
    }, t.prototype.ra = function(t, e) {
        return xn(t).put(this.serializer._a(e));
    }, 
    /**
    ...
    t.prototype.ha = function(t, e) {
        ...
        // depends on the queryTargets index to be efficient.
                return xn(t).Vo({
            range: i,
            index: Jn.queryTargetsIndexName
        }, (function(t, r, i) {
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = cn(e.path);
            i.push(o.put(new $n(n, s))), i.push(r.yo.vn(t, e));
        })), Ye.Kn(i);
        ...
        // IndexedDb.
            ...
            var o = cn(e.path);
            return Ye.Kn([ i.delete([ n, o ]), r.yo.Dn(t, e) ]);
        }));
    }, t.prototype.ua = function(t, e) {
        var n = Ln(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Ln(t), i = ue();
        return r.Vo({
            range: n,
            Po: !0
        }, (function(t, e, n) {
            var r = pn(t[1]), o = new P(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.Mn = function(t, e) {
        var n = cn(e.path), r = IDBKeyRange.bound([ n ], [ Me(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ln(t).Vo({
            index: $n.documentTargetsIndex,
            Po: !0,
            range: r
        }, (function(t, e, n) {
            var r = t[0];
    ...
    t.prototype.ui = function(t, e) {
        var n = this;
        return xn(t).get(e).next((function(t) {
 ...
 */
function xn(t) {
    return cr.co(t, Jn.store);
}

function Rn(t) {
    return dn.co(t, tr.store).get(tr.key).next((function(t) {
        return Oe(null !== t), t;
    }));
}

function Vn(t) {
    return Rn(t).next((function(t) {
 ...
 */ var On = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Cn(t).get(Un(e)).next((function(t) {
            return n.wa(t);
        }));
    }, 
    /**
    ...
    t.prototype.Pa = function(t, e) {
        var n = this, r = ee(), i = new C(P.k);
        return this.ma(t, e, (function(t, e) {
            var o = n.wa(e);
            o ? (r = r.nt(t, o), i = i.nt(t, Mn(e))) : (r = r.nt(t, null), i = i.nt(t, 0));
        })).next((function() {
            return {
                Va: r,
                ga: i
        ...
        var r = this, i = re(), o = e.path.length + 1, s = {};
        if (n.isEqual(x.MIN)) {
            ...
            /* open= */ !0), s.index = Hn.collectionReadTimeIndex;
        }
        return Cn(t).Vo(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.U(u.key.path) ? u instanceof xt && e.matches(u) && (i = i.nt(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    t.prototype.ba = function(t, e) {
        var n = this, r = te(), i = this.serializer.pa(e), o = Cn(t), s = IDBKeyRange.lowerBound(i, !0);
        return o.Vo({
            index: Hn.readTimeIndex,
            range: s
        }, (function(t, e) {
    ...
    t.prototype.Da = function(t) {
        ...
        return Pn(t).get(Xn.key).next((function(t) {
            return Oe(!!t), t;
        }));
    }, t.prototype.Ia = function(t, e) {
        return Pn(t).put(Xn.key, e);
    }, 
    /**
    ...
    t.prototype.wa = function(t) {
        if (t) {
            ...
            return e instanceof Rt && e.version.isEqual(x.S()) ? null : e;
        }
        return null;
    }, t;
}();
 ...
 */ function Pn(t) {
    return cr.co(t, Xn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Cn(t) {
    return cr.co(t, Hn.store);
}
 ...
 */ On.Fa = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).$a = t, r.Na = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.Ma = new Fe((function(t) {
            return t.toString();
        })), r;
    }
    return t(n, e), n.prototype.ir = function(t) {
        var e = this, n = [], r = 0, i = new q((function(t, e) {
            return Ce(t.K(), e.K());
        }));
        return this.zn.forEach((function(o, s) {
            ...
            if (s) {
                ...
                var c = e.$a.serializer.La(new Rt(o, x.S()), e.readTime);
                n.push(e.$a.Jn(t, o, c));
            } else n.push(e.$a.Zn(t, o));
        })), i.forEach((function(r) {
            n.push(e.$a.ur.Mo(t, r));
        })), n.push(this.$a.updateMetadata(t, r)), Ye.Kn(n);
...
var qn = /** @class */ function() {
    ...
    return t.prototype.Mo = function(t, e) {
        return this.Oa.add(e), Ye.resolve();
    }, t.prototype.Pr = function(t, e) {
        return Ye.resolve(this.Oa.getEntries(e));
    }, t;
}(), jn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.B(), n = t.L(), r = this.index[e] || new q(V.k), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.B(), n = t.L(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new q(V.k)).j();
    }, t;
}(), Fn = 10, Gn = /** @class */ function() {
    function t(t) {
        this.serializer = t;
    }
    /**
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        ...
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore(Kn.store, {
                ...
                keyPath: Yn.keyPath,
                autoIncrement: !0
            }).createIndex(Yn.userMutationsIndex, Yn.userMutationsKeyPath, {
                unique: !0
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore($n.store), t.deleteObjectStore(Jn.store), t.deleteObjectStore(tr.store);
        }(t), nr(t)), s = s.next((function() {
            /**
     ...
     */
            return function(t) {
                var e = t.store(tr.store), n = new tr(
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, x.MIN.F(), 
                /*targetCount=*/ 0);
                return e.put(tr.key, n);
            }(o);
        }))), n < 4 && r >= 4 && (0 !== n && (
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Yn.store).Ro().next((function(n) {
                    t.deleteObjectStore(Yn.store), t.createObjectStore(Yn.store, {
                        keyPath: Yn.keyPath,
                        autoIncrement: !0
                    }).createIndex(Yn.userMutationsIndex, Yn.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store(Yn.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return Ye.Kn(i);
                }));
            ...
            !function(t) {
                ...
                var e = t.objectStore(Hn.store);
                e.createIndex(Hn.readTimeIndex, Hn.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(Hn.collectionReadTimeIndex, Hn.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(Hn.store).Vo((function(t, n) {
            e += Mn(n);
        })).next((function() {
            var n = new Xn(e);
            return t.store(Xn.store).put(Xn.key, n);
        }));
    }, t.prototype.removeAcknowledgedMutations = function(t) {
        var e = this, n = t.store(Kn.store), r = t.store(Yn.store);
        return n.Ro().next((function(n) {
            return Ye.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Ro(Yn.userMutationsIndex, i).next((function(r) {
                    return Ye.forEach(r, (function(r) {
                        Oe(r.userId === n.userId);
                        var i = e.serializer.Oo(r);
                        return Nn(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store($n.store), n = t.store(Hn.store);
        return Vn(t).next((function(t) {
            ...
            return n.Vo((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? Ye.resolve() : function(n) {
                        return e.put(new $n(0, cn(n), t));
                    }(o);
                })));
            })).next((function() {
                return Ye.Kn(r);
        ...
        var n = e.store(er.store), r = new jn, i = function(t) {
            if (r.add(t)) {
                var e = t.B(), i = t.L();
                return n.put({
                    collectionId: e,
        ...
        // Index existing remote documents.
                return e.store(Hn.store).Vo({
            Po: !0
        }, (function(t, e) {
            var n = new V(t);
            return i(n.L());
        })).next((function() {
            return e.store(Qn.store).Vo({
                Po: !0
            }, (function(t, e) {
                t[0];
                var n = t[1], r = (t[2], pn(n));
                return i(r.L());
            }));
        }));
    }, t.prototype.rewriteCanonicalIds = function(t) {
        var e = this, n = t.store(Jn.store);
...
/** Name of the IndexedDb object store.  */ Yn.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
Yn.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
Yn.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
Yn.userMutationsKeyPath = [ "userId", "batchId" ];
...
/**
     ...
     */
Hn.readTimeIndex = "readTimeIndex", Hn.readTimeIndexPath = "readTime", 
/**
     ...
     */
Hn.collectionReadTimeIndex = "collectionReadTimeIndex", Hn.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
Xn.store = "remoteDocumentGlobal", Xn.key = "remoteDocumentGlobalKey";
...
Jn.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
Jn.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store.  */ $n.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
$n.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
$n.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
$n.documentTargetsKeyPath = [ "path", "targetId" ];
 ...
 */ tr.key = "targetGlobalKey", tr.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ function nr(t) {
    t.createObjectStore($n.store, {
        keyPath: $n.keyPath
    }).createIndex($n.documentTargetsIndex, $n.documentTargetsKeyPath, {
        unique: !0
    }), 
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore(Jn.store, {
        keyPath: Jn.keyPath
    }).createIndex(Jn.queryTargetsIndexName, Jn.queryTargetsKeyPath, {
        unique: !0
    }), t.createObjectStore(tr.store);
}

er.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
er.keyPath = [ "collectionId", "parent" ];
...
var ir = r(r(r([ Kn.store, Yn.store, Qn.store, Hn.store, Jn.store, zn.store, tr.store, $n.store ], [ rr.store ]), [ Xn.store ]), [ er.store ]), or = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.Mo = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ Me(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return sr(t).Ro(r).next((function(t) {
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ var ur = /** @class */ function() {
    function t(t) {
        this.Ba = t;
    }
    /** Decodes a remote document from storage locally to a Document. */    return t.prototype.ya = function(t) {
        ...
        if (t.noDocument) {
            var e = P.it(t.noDocument.path), n = this.qa(t.noDocument.readTime);
            return new Rt(e, n, {
                hasCommittedMutations: !!t.hasCommittedMutations
            });
        }
        if (t.unknownDocument) {
            var r = P.it(t.unknownDocument.path), i = this.qa(t.unknownDocument.version);
            return new Vt(r, i);
        }
        return Le();
    }, 
    /** Encodes a document for storage locally. */ t.prototype.La = function(t, e) {
        ...
        var e = t.F();
        return new Bn(e.seconds, e.nanoseconds);
    ...
    /** Encodes a batch of mutations into a DbMutationBatch for local storage. */ t.prototype.$o = function(t, e) {
        ...
        return new Yn(t, e.batchId, e.An.toMillis(), r, i);
    }, 
    /** Decodes a DbMutationBatch into a MutationBatch */ t.prototype.Oo = function(t) {
        var e = this, n = (t.baseMutations || []).map((function(t) {
            ...
            return e.Ba.xi(t);
        })), i = k.fromMillis(t.localWriteTimeMs);
        return new Ge(t.batchId, i, n, r);
    }, 
    /** Decodes a DbTarget into TargetData */ t.prototype.ca = function(t) {
        var e, n = this.qa(t.readTime), r = void 0 !== t.lastLimboFreeSnapshotVersion ? this.qa(t.lastLimboFreeSnapshotVersion) : x.MIN;
        return e = void 0 !== t.query.documents ? this.Ba.Ki(t.query) : this.Ba.Ji(t.query), 
        new Wt(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, n, r, z.fromBase64String(t.resumeToken));
    }, 
    /** Encodes TargetData into a DbTarget for storage locally. */ t.prototype._a = function(t) {
        ...
        // lastListenSequenceNumber is always 0 until we do real GC.
                return new Jn(t.targetId, t.target.canonicalId(), n, i, t.sequenceNumber, r, e);
    }, t;
}(), ar = "Another tab has exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs.", hr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).jo = t, r.Qa = n, r;
    }
    return t(n, e), n;
}(We), cr = /** @class */ function() {
    function t(e, n, r, i, o, s, u, a) {
        ...
        }, !t.ho()) throw new T(I.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        if (this.yo = new pr(this, o), this.Ja = n + t.Xa, this.serializer = new ur(u), 
        this.document = i.document, this.Za = new kn(this.yo, this.serializer), this.ur = new or, 
        this.or = new On(this.serializer, this.ur), !i.window || !i.window.localStorage) throw new T(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        this.window = i.window, this.tu = this.window.localStorage;
    }
    return t.co = function(t, e) {
        if (t instanceof hr) return dn.co(t.jo, e);
        throw Le();
    }, 
    /**
    ...
    t.prototype.start = function() {
        var t = this;
        return dn.ro(this.Ja, Fn, new Gn(this.serializer)).then((function(e) {
            return t.eu = e, t.su();
        })).then((function() {
            return t.iu(), t.nu(), t.ru(), t.eu.runTransaction("readonly", [ tr.store ], (function(t) {
                return Vn(t);
            }));
        })).then((function(e) {
            t.hu = new Je(e, t.Wa);
    ...
    t.prototype.ou = function(t) {
        var r = this;
        return this.Ya = function(i) {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(e) {
                    return this.Kh ? [ 2 /*return*/ , t(i) ] : [ 2 /*return*/ ];
                }));
            }));
        }, t(this.isPrimary);
    }, 
    ...
    t.prototype.su = function() {
        var t = this;
        return this.eu.runTransaction("readwrite", ir, (function(e) {
            return lr(e).put(new rr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
            ...
            return xe("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", e), 
            /* isPrimary= */ !1;
        })).then((function(e) {
        ...
        var e = this;
        return fr(t).get(zn.key).next((function(t) {
            return Ye.resolve(e.fu(t));
        }));
                ...
                switch (n.label) {
                  case 0:
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(n) {
                        var r = t.co(n, rr.store);
                        return r.Ro().next((function(t) {
                            var n = e.wu(t, 18e5), i = t.filter((function(t) {
                                return -1 === n.indexOf(t);
                            }));
                            // Delete metadata for clients that are no longer considered active.
                                                        return Ye.forEach(i, (function(t) {
                  ...
                  case 1:
                    ...
                    n.sent().forEach((function(t) {
                        e.window.localStorage.removeItem(e.Ru(t.clientId));
                    })), n.label = 2;
    ...
    t.prototype._u = function(t) {
        var e = this;
        return fr(t).get(zn.key).next((function(n) {
            ...
            if (null !== n && e.Iu(n.leaseTimestampMs, 5e3) && !e.Au(n.ownerId)) {
                ...
                if (!e.fu(n)) {
                    ...
                    throw new T(I.FAILED_PRECONDITION, ar);
                    return !1;
                }
            }
            return !(!e.networkEnabled || !e.inForeground) || lr(t).Ro().next((function(t) {
            ...
            return e.isPrimary !== t && xe("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.gu(), [ 4 /*yield*/ , this.eu.runTransaction("readwrite", [ zn.store, rr.store ], (function(e) {
    ...
    t.prototype.yu = function() {
        var t = this;
        return this.eu.runTransaction("readonly", [ rr.store ], (function(e) {
            return lr(e).Ro().next((function(e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return t.ho() ? (e = r + t.Xa, [ 4 /*yield*/ , dn.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
        ...
        return In.vo(t, this.serializer, this.ur, this.yo);
        ...
        var r = this;
        xe("IndexedDbPersistence", "Starting transaction:", t);
        var i, o = "readonly" === e ? "readonly" : "readwrite";
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.eu.runTransaction(o, ir, (function(o) {
            return i = new hr(o, r.hu.next()), "readwrite-primary" === e ? r.cu(o).next((function(t) {
                return !!t || r._u(o);
            })).next((function(e) {
                if (!e) throw Re("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Nr.Zr((function() {
                    return r.Ya(!1);
                })), new T(I.FAILED_PRECONDITION, Ze);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.Cu = function(t) {
        var e = this;
        return fr(t).get(zn.key).next((function(t) {
            if (null !== t && e.Iu(t.leaseTimestampMs, 5e3) && !e.Au(t.ownerId) && !e.fu(t) && !t.allowTabSynchronization) throw new T(I.FAILED_PRECONDITION, ar);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.lu = function(t) {
        ...
        return n.get(zn.key).next((function(t) {
            return e.fu(t) ? (xe("IndexedDbPersistence", "Releasing primary lease."), n.delete(zn.key)) : Ye.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.Iu = function(t, e) {
        var n = Date.now();
        return !(t < n - e || t > n && (Re("Detected an update time that is in the future: " + t + " > " + n), 
        1));
    ...
    t.prototype.Au = function(t) {
        try {
            ...
            return xe("IndexedDbPersistence", "Client '" + t + "' " + (e ? "is" : "is not") + " zombied in LocalStorage"), 
            e;
        } catch (t) {
            // Gracefully handle if LocalStorage isn't working.
            return Re("IndexedDbPersistence", "Failed to get zombied client id.", t), !1;
        }
    }, 
    /**
    ...
    t.prototype.Pu = function() {
        try {
            ...
            Re("Failed to set zombie client id.", t);
        }
    }, 
 ...
 */ function lr(t) {
    return t.store(rr.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ cr.Xa = "main";

var pr = /** @class */ function() {
    function t(t, e) {
        this.db = t, this.Nu = null, this.qh = new hn(this, e);
    }
    ...
    t.prototype.Lu = function(t, e) {
        return this.Nu.Mn(e) ? Ye.resolve(!0) : function(t, e) {
            var n = !1;
            return Sn(t).po((function(r) {
                return Tn(t, r, e).next((function(t) {
                    return t && (n = !0), Ye.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n.Lu(t, s).next((function(e) {
                    ...
                    return o++, r.tr(t, s).next((function() {
                        return r.Zn(s), Ln(t).delete([ 0, cn(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var yr = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.Qu = x.MIN, this.persistence.yo.Mu(this.Bu), this.ar = t.bu(n), this.Wu = t.Su(), 
        this.Za = t.vu(), this.ju = new He(this.Wu, this.ar, this.persistence.Du()), this.xu.Ku(this.ju)
    ...
    t.prototype.Gu = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.ar, r = this.ju, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.ar.Uo(n).next((function(s) {
                            return i = s, e = o.persistence.bu(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new He(o.Wu, e, o.persistence.Du()), e.Uo(n);
                        })).next((function(t) {
                            for (var e = [], o = [], s = ue(), u = 0, a = i
                            ...
                            // of mutation batch IDs that were affected by change.
                                                        return r.Tr(n, s).next((function(t) {
                                return {
                                    zu: t,
                                    Hu: e,
                                    Yu: o
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.ar = e, this.ju = r, this.xu.Ku(this.ju), 
                    i) ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.ju.Tr(o, i).next((function(i) {
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    ...
                    // exists=true
                    s.push(new Tt(h.key, c, c.se(), wt.exists(!0)));
                }
    ...
    t.prototype.Zu = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.ar.Lo(n, t).next((function(t) {
                return Oe(null !== t), r = t.keys(), e.ar.Wo(n, t);
            })).next((function() {
                return e.ar.zo(n);
            })).next((function() {
                return e.ju.Tr(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.Is.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof Rt && h.version.isEqual(x.MIN) ? (
                    ...
                    a = a.nt(i, h)) : xe("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
    ...
    t.ec = function(t, e, n) {
        ...
        return Oe(e.resumeToken.Ot() > 0), 0 === t.resumeToken.Ot() || (e.ts.C() - t.ts.C() >= this.sc || n.Ps.size + n.Vs.size + n.gs.size > 0);
    ...
    t.prototype.ic = function(t) {
        ...
        return this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(n) {
            return Ye.forEach(t, (function(t) {
                return Ye.forEach(t.yr, (function(t) {
    ...
    t.prototype.hc = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Za.da(n, t).next((function(i) {
                ...
                r = i, Ye.resolve(r)) : e.Za.Xo(n).next((function(i) {
                    return r = new Wt(t, i, 0 /* Listen */ , n.Qa), e.Za.na(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.da = function(t, e) {
        var n = this.Uu.get(e);
        return void 0 !== n ? Ye.resolve(this.qu.get(n)) : this.Za.da(t, e);
    }, 
    /**
    ...
    t.prototype.oc = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(i) {
            ...
            var o = n.Bu.Nn(t);
            return e ? Ye.resolve() : Ye.forEach(o, (function(t) {
    ...
    t.prototype.ac = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.da(o, t.xe()).next((function(t) {
                ...
                return n.xu.wr(o, t, e ? r : x.MIN, e ? i : ue());
            })).next((function(t) {
                return {
                    documents: t,
                    uc: i
    ...
    t.prototype.cc = function(t) {
        ...
        var r = this, i = e.batch, o = i.keys(), s = Ye.resolve();
        return o.forEach((function(r) {
            s = s.next((function() {
                return n.tr(t, r);
            })).next((function(t) {
                var o = t, s = e.gn.get(r);
                Oe(null !== s), (!o || o.version.D(s) < 0) && ((o = i.qt(r, o, e)) && 
...
var vr = /** @class */ function(r) {
    function i(t, e, n) {
        var i = this;
        return (i = r.call(this, t, e, n) || this).persistence = t, i.ar = t.bu(n), i.Wu = t.Su(), 
        i.Za = t.vu(), i;
    }
    /** Starts the LocalStore. */    return t(i, r), i.prototype.start = function() {
        return this._c();
    }, 
    /** Returns the local view of the documents affected by a mutation batch. */ i.prototype.lc = function(t) {
        var e = this;
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", (function(n) {
            return e.ar.xo(n, t).next((function(t) {
                return t ? e.ju.Tr(n, t) : Ye.resolve(null);
            }));
        }));
    }, i.prototype.dc = function(t) {
        this.ar.Ko(t);
    }, i.prototype.uu = function(t) {
 ...
 */ function mr(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== I.FAILED_PRECONDITION || t.message !== Ze) throw t;
            return xe("LocalStore", "Unexpectedly lost primary lease"), [ 2 /*return*/ ];
        }));
    }));
}
 ...
 */ function gr(t, e) {
    if (0 !== e.length) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + Pr(e.length, "argument") + ".");
}
 ...
 */ function Er(t, e, n) {
    if (e.length !== n) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires " + Pr(n, "argument") + ", but was called with " + Pr(e.length, "argument") + ".");
}
 ...
 */ function wr(t, e, n) {
    if (e.length < n) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires at least " + Pr(n, "argument") + ", but was called with " + Pr(e.length, "argument") + ".");
}
 ...
 */ function br(t, e, n, r) {
    if (e.length < n || e.length > r) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + Pr(e.length, "argument") + ".");
}
...
function Ar(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = kr(r);
        throw new T(I.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */
/** Helper to validate the type of a provided input. */ function Sr(t, e, n, r) {
    if (!("object" === e ? Dr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = kr(r);
        throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
/** Returns a string describing the type / value of the provided input. */ function kr(t) {
    ...
    return "function" == typeof t ? "a function" : Le();
}

function xr(t, e, n) {
    if (void 0 === n) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + Or(e) + " argument, but it was undefined.");
}
 ...
 */ function Rr(t, e, n) {
    G(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new T(I.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function Vr(t, e, n, r) {
    var i = kr(r);
    return new T(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + Or(n) + " argument to be a " + e + ", but it was: " + i);
}

function Lr(t, e, n) {
    if (n <= 0) throw new T(I.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + Or(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function Or(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 */ function Cr(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new T(I.INVALID_ARGUMENT, t);
    }
...
function Ur() {
    if ("undefined" == typeof Uint8Array) throw new T(I.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function Mr() {
    if (!Ae.Lt().Tc) throw new T(I.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var qr = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        Er("Blob.fromBase64String", arguments, 1), Ir("Blob.fromBase64String", "string", 1, e), 
        Mr();
        try {
            return new t(z.fromBase64String(e));
        } catch (e) {
            throw new T(I.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
        if (Er("Blob.fromUint8Array", arguments, 1), Ur(), !(e instanceof Uint8Array)) throw Vr("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(z.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return Er("Blob.toBase64", arguments, 0), Mr(), this.Ec.toBase64();
    }, t.prototype.toUint8Array = function() {
        return Er("Blob.toUint8Array", arguments, 0), Ur(), this.Ec.toUint8Array();
    }, t.prototype.toString = function() {
        return "Blob(base64: " + this.toBase64() + ")";
    }, t.prototype.isEqual = function(t) {
        return this.Ec.isEqual(t.Ec);
    }, t;
}(), jr = Cr(qr, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Fr = /** @class */ function() {
    /**
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new T(I.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + Pr(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (Ir("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new T(I.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.Ic = new O(t);
    }
    return t.documentId = function() {
        return t.wc;
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Vr("isEqual", "FieldPath", 1, e);
 ...
 */
var Gr = new RegExp("[~\\*/\\[\\]]"), Br = /** @class */ function() {
    function t(t) {
        this.Rc = t;
    }
    return t.delete = function() {
        return gr("FieldValue.delete", arguments), zr.instance;
    }, t.serverTimestamp = function() {
        return gr("FieldValue.serverTimestamp", arguments), Kr.instance;
    }, t.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return wr("FieldValue.arrayUnion", arguments, 1), new Yr(t);
    }, t.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return wr("FieldValue.arrayRemove", arguments, 1), new Qr(t);
    }, t.increment = function(t) {
        return Ir("FieldValue.increment", "number", 1, t), Er("FieldValue.increment", arguments, 1), 
        new Zr(t);
    }, t.prototype.isEqual = function(t) {
        return this === t;
    }, t;
 ...
 */
/** Singleton instance. */ zr.instance = new zr;
...
/** Singleton instance. */ Kr.instance = new Kr;

var Yr = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayUnion") || this).Ac = t, n;
    }
    return t(n, e), n;
}(Br), Qr = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayRemove") || this).Ac = t, n;
    }
    return t(n, e), n;
}(Br), Zr = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.increment") || this).mc = t, n;
    }
    return t(n, e), n;
}(Br), Wr = Cr(Br, "Use FieldValue.<field>() instead."), Hr = /** @class */ function() {
    function t(t, e) {
        if (Er("GeoPoint", arguments, 2), Ir("GeoPoint", "number", 1, t), Ir("GeoPoint", "number", 2, e), 
        !isFinite(t) || t < -90 || t > 90) throw new T(I.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new T(I.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Pc = t, this.Vc = e;
    }
     ...
     */
    t.prototype.p = function(t) {
        return Ce(this.Pc, t.Pc) || Ce(this.Vc, t.Vc);
    }, t;
}(), Xr = /^__.*__$/, Jr = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.se = e, this.fieldTransforms = n;
    }
    return t.prototype.gc = function(t, e) {
        var n = [];
        return null !== this.se ? n.push(new Tt(t, this.data, this.se, e)) : n.push(new It(t, this.data, e)), 
        this.fieldTransforms.length > 0 && n.push(new Nt(t, this.fieldTransforms)), n;
    }, t;
}(), $r = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.se = e, this.fieldTransforms = n;
    ...
    return t.prototype.gc = function(t, e) {
        var n = [ new Tt(t, this.data, this.se, e) ];
        return this.fieldTransforms.length > 0 && n.push(new Nt(t, this.fieldTransforms)), 
        n;
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var ei = /** @class */ function() {
    /**
    ...
    return t.prototype.vc = function(e) {
        ...
        return new T(I.INVALID_ARGUMENT, "Function " + this.methodName + "() called with invalid data. " + t + e);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ti(this.pc) && Xr.test(t)) throw this.Fc('Document fields cannot begin and end with "__"');
    }, t;
}(), ni = function(t, e) {
    ...
    return t.prototype.kc = function(t, e) {
        var n = new ei(0 /* Set */ , t, O.H);
        oi("Data must be an object, but it was:", n, e);
        var r = this.$c(e, n);
        return new Jr(new St(r), 
        /* fieldMask= */ null, n.fieldTransforms);
    }, 
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Mc = function(t, e, n) {
        var r = new ei(2 /* MergeSet */ , t, O.H);
        oi("Data must be an object, but it was:", r, e);
        var i, o, s = this.$c(e, r);
        if (n) {
            for (var u = new q(O.k), a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
                if (c instanceof Fr) f = c.Ic; else {
                    if ("string" != typeof c) throw Le();
                    f = ui(t, c);
                }
                if (!r.contains(f)) throw new T(I.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                u = u.add(f);
            }
            i = mt.Kt(u), o = r.fieldTransforms.filter((function(t) {
                return i.zt(t.field);
            }));
        } else i = mt.Gt(r.se), o = r.fieldTransforms;
        return new Jr(new St(s), i, o);
    }, 
    /** Parse update data from an update() call. */ t.prototype.Lc = function(t, e) {
        var n = this, r = new ei(1 /* Update */ , t, O.H);
        oi("Data must be an object, but it was:", r, e);
        var i = new q(O.k), o = St._e();
        G(e, (function(e, s) {
            var u = ui(t, e), a = r.Dc(u);
            if ((s = n.Oc(s, a)) instanceof zr) 
        ...
        var s = mt.Kt(i);
        return new $r(o.he(), s, r.fieldTransforms);
    }, 
    /** Parse update data from a list of field/value arguments. */ t.prototype.Bc = function(t, e, n, r) {
        var i = new ei(1 /* Update */ , t, O.H), o = [ si(t, e) ], s = [ n ];
        if (r.length % 2 != 0) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() needs to be called with an even number of arguments that alternate between field names and values.");
        for (var u = 0; u < r.length; u += 2) o.push(si(t, r[u])), s.push(r[u + 1]);
        for (var a = new q(O.k), h = St._e(), c = 0; c < o.length; ++c) {
            var f = o[c], l = i.Dc(f), p = this.Oc(s[c], l);
            if (p instanceof zr) 
            // Add it to the field mask, but don't add anything to updateData.
            a = a.add(f); else {
                var d = this.xc(p, l);
        ...
        var y = mt.Kt(a);
        return new $r(h.he(), y, i.fieldTransforms);
    }, 
    /**
    ...
    t.prototype.qc = function(t, e, n) {
        void 0 === n && (n = !1);
        var r = new ei(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t, O.H);
        return this.xc(e, r);
    }, 
    ...
    t.prototype.xc = function(t, e) {
        if (ii(t = this.Oc(t, e))) return oi("Unsupported field value:", e, t), this.$c(t, e);
        if (t instanceof Br) 
        ...
        e.path && e.path.length > 0 && e.se.push(e.path) : G(t, (function(t, i) {
            var o = n.xc(i, e.vc(t));
            null != o && (r[t] = o);
        })), {
            mapValue: {
    ...
    t.prototype.Uc = function(t, e) {
        ...
        if (!ti(e.pc)) throw e.Fc(t.Rc + "() can only be used with update() and set()");
        ...
        if (t instanceof zr) {
            ...
            // fieldMask so it gets deleted.
                        e.se.push(e.path);
        } else if (t instanceof Kr) e.fieldTransforms.push(new gt(e.path, lt.instance)); else if (t instanceof Yr) {
            var n = this.jc(t.Rc, t.Ac), r = new pt(n);
            e.fieldTransforms.push(new gt(e.path, r));
        } else if (t instanceof Qr) {
            var i = this.jc(t.Rc, t.Ac), o = new dt(i);
            e.fieldTransforms.push(new gt(e.path, o));
        } else if (t instanceof Zr) {
            var s = this.qc("FieldValue.increment", t.mc), u = new yt(this.serializer, s);
            e.fieldTransforms.push(new gt(e.path, u));
        } else Le();
    }, 
    /**
    ...
    t.prototype.Wc = function(t, e) {
        ...
        throw e.Fc("Unsupported field value: " + kr(t));
 ...
 */
function ii(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof k || t instanceof Hr || t instanceof qr || t instanceof ni || t instanceof Br);
}
 ...
 */ function si(t, e) {
    if (e instanceof Fr) return e.Ic;
    if ("string" == typeof e) return ui(t, e);
    throw new T(I.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. Field path arguments must be of type string or FieldPath.");
}
 ...
 */ function ui(t, e) {
    try {
        return function(t) {
            if (t.search(Gr) >= 0) throw new T(I.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (Fr.bind.apply(Fr, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new T(I.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).Ic;
    } catch (e) {
        var n = ai(e);
        throw new T(I.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
}
 ...
 */ var hi = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Hc = 0, this.Yc = null, this.stream = null, this.oh = new tn(t, e)
        /**
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.h_(r) ];
    ...
    t.prototype.r_ = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new T(I.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.u_(e);
            }));
        }));
    ...
    t.prototype.u_ = function(t) {
        ...
        return xe("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.o_ = function(t) {
        ...
        return function(n) {
            e.Nr.Zr((function() {
                return e.Hc === t ? n() : (xe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    n.prototype.start = function() {
        this.E_ = !1, e.prototype.start.call(this);
        ...
        Oe(!!t.streamToken), this.lastStreamToken = this.serializer.Ii(t.streamToken), this.E_) {
        ...
        // The first response is always the handshake response
                return Oe(!t.writeResults || 0 === t.writeResults.length), this.E_ = !0, 
        this.listener.A_();
    }, 
    /**
    ...
    return t.prototype.P_ = function(t) {
        return new fi(this.Nr, this.Gc, this.credentials, this.serializer, t);
    }, t.prototype.V_ = function(t) {
        return new ci(this.Nr, this.Gc, this.credentials, this.serializer, t);
    ...
    /** Gets an auth token and invokes the provided RPC. */ t.prototype.g_ = function(t, e) {
        ...
        return this.credentials.getToken().then((function(r) {
            ...
            throw t.code === I.UNAUTHENTICATED && n.credentials._(), t;
        }));
    }, 
    ...
    function t(t) {
        ...
        this.v_ = oe(), this.mutations = [], this.S_ = !1, 
        /**
    ...
    return t.prototype.p_ = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.F_(), this.mutations.length > 0) throw new T(I.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , this.b_.p_(t) ];

                  case 1:
                    return [ 2 /*return*/ , ((e = n.sent()).forEach((function(t) {
                        t instanceof Rt || t instanceof xt ? r.N_(t) : Le();
                    })), e) ];
                }
            }));
        }));
        ...
        this.write([ new _t(t, this.Zt(t)) ]), this.C_.add(t);
                ...
                switch (n.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        e.mutations.push(new At(t, e.Zt(t)));
                    })), [ 4 /*yield*/ , this.b_.commit(this.mutations) ];

                  case 1:
                    // For each mutation, note that the doc was written.
                    return n.sent(), this.S_ = !0, [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        if (null !== n) {
            ...
            throw new T(I.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.Zt = function(t) {
        var e = this.v_.get(t);
        return !this.C_.has(t) && e ? wt.updateTime(e) : wt.NONE;
    }, 
    /**
    ...
    t.prototype.k_ = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new T(I.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    t.prototype.set = function(t) {
        ...
        this.x_ ? (Re(e), this.x_ = !1) : xe("OnlineStateTracker", e);
    ...
    r, i, o, s) {
        ...
        /**
             ...
             */
        this.networkEnabled = !1, this.isPrimary = !1, this.H_ = s, this.H_.Y_((function(t) {
            i.Zr((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.J_() ? (xe("RemoteStore", "Restarting streams for network reachability change."), 
    ...
    t.prototype.disableNetwork = function() {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.K_.length > 0 && (xe("RemoteStore", "Stopping write stream with " + this.K_.length + " pending writes"), 
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return xe("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, 
                    [ 4 /*yield*/ , this._l() ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    return this.Z_.set("Online" /* Online */), t instanceof me && 2 /* Removed */ === t.state && t.cause ? [ 2 /*return*/ , this.Il(t) ] : (t instanceof ye ? this.z_.zs(t) : t instanceof ve ? this.z_.si(t) : this.z_.Js(t), 
                    r.isEqual(x.MIN) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.j_.ea() ]);

                  case 1:
                    return e = n.sent(), r.D(e) >= 0 ? [ 4 /*yield*/ , this.wl(r) ] : [ 3 /*break*/ , 3 ];
    ...
    t.prototype.wl = function(t) {
        ...
        n.Es.forEach((function(t) {
            ...
            if (n) {
                ...
                var r = new Wt(n.target, t, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                e.dl(r);
            }
        })), this.El.tc(n);
    }, 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return null !== (e = n.sent()) ? [ 3 /*break*/ , 2 ] : (0 === this.K_.length && this.nl.e_(), 
                    [ 3 /*break*/ , 4 ]);

                  case 2:
                    return this.ml(e), [ 4 /*yield*/ , this.cl() ];
    ...
    t.prototype.ml = function(t) {
        ...
        var n = this, r = this.K_.shift(), i = Be.from(r, t, e, this.nl.lastStreamToken);
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                return t && this.K_.length > 0 ? [ 2 /*return*/ , (e = this.nl.I_ ? this.yl(t) : this.bl(t), 
                e.then((function() {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                ...
                return Xt(t.code) ? [ 2 /*return*/ , (xe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.nl.lastStreamToken), 
                this.nl.lastStreamToken = z.xt, this.j_.No(z.xt).catch(mr)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                // logic kick in.
                return Xt(r = t.code) && r !== I.ABORTED ? (e = this.K_.shift(), [ 2 /*return*/ , (this.nl.t_(), 
                this.El.vl(e.batchId, t).then((function() {
                    return i.cl();
                }))) ]) : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Sl = function() {
        return new pi(this.b_);
            ...
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    xe("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.X_() ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return (e = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this._l() ];

                  case 3:
                    n.sent(), e = this.Z_.set("Unknown" /* Unknown */), n.label = 4;
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function mi(t, e, n) {
...
/** Assembles the key for a query state in WebStorage */ function gi(t, e) {
...
var Ei = /** @class */ function() {
    ...
    return t.Fl = function(e, n, r) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (s = new T(i.error.code, i.error.message))), 
        o ? new t(e, n, i.state, s) : (Re("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.Fl = function(e, n) {
        ...
        return i && r.error && ((i = "string" == typeof r.error.message && "string" == typeof r.error.code) && (o = new T(r.error.code, r.error.message))), 
        i ? new t(e, r.state, o) : (Re("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.Nl = function() {
        var t = {
            state: this.state,
    ...
    return t.Fl = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = he(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Q(r.activeTargetIds[s]), 
        o = o.add(r.activeTargetIds[s]);
        return i ? new t(e, o) : (Re("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), Ii = /** @class */ function() {
    function t(t, e) {
    ...
    return t.Fl = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (Re("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), Ti = /** @class */ function() {
    function t() {
    ...
    function t(e, n, r, i, o) {
        ...
        this.M_ = null, this.vr = null, this.Ll = this.Ol.bind(this), this.xl = new C(Ce), 
        this.Kh = !1, 
        /**
             * Captures WebStorage events that occur before `start()` is called. These
             * events are replayed once `WebStorageSharedClientState` is started.
             */
        this.Bl = [], !t.ho(this.platform)) throw new T(I.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                var s = r.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = o, this.ql = vi(this.persistenceKey, this.Ml), 
        this.Ul = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.xl = this.xl.nt(this.Ml, new Ti), this.Ql = new RegExp("^firestore_clients_" + s + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.ho = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.Ml && (o = this.getItem(vi(this.persistenceKey, i))) && (s = bi.Fl(i, o)) && (this.xl = this.xl.nt(s.clientId, s));
        ...
        // by another tab
                if (this.Xl(t)) {
            var n = this.storage.getItem(gi(this.persistenceKey, t));
            if (n) {
                var r = wi.Fl(t, n);
                r && (e = r.state);
            }
        ...
        this.removeItem(gi(this.persistenceKey, t));
        ...
        return xe("SharedClientState", "READ", t, e), e;
    }, t.prototype.setItem = function(t, e) {
        xe("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
    }, t.prototype.removeItem = function(t) {
        xe("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
    }, t.prototype.Ol = function(t) {
        var r = this;
        if (t.storageArea === this.storage) {
            if (xe("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.ql) return void Re("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Nr.Ih((function() {
                return e(r, void 0, void 0, (function() {
                    var e, r, i, o, s, u;
                    return n(this, (function(n) {
                        if (this.Kh) {
                            if (null !== t.key) if (this.Ql.test(t.key)) {
                                if (null == t.newValue) return e = this.fd(t.key), [ 2 /*return*/ , this.Td(e, null) ];
                                ...
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                    Oe("number" == typeof n), e = n;
                                } catch (t) {
                                    Re("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }(t.newValue)) !== Je.Fr && this.vr(u);
                        } else this.Bl.push(t);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new Ei(this.currentUser, t, e, n), i = mi(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Nl());
    }, t.prototype.sd = function(t) {
        var e = mi(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = gi(this.persistenceKey, t), i = new wi(t, e, n);
        this.setItem(r, i.Nl());
    }, 
    /**
    ...
    t.prototype.zl = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.El.md(t.batchId, t.state, t.error) ] : (xe("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    }, t.prototype.Ad = function(t) {
    ...
    function t() {
        this.gd = new Ti, this.pd = {}, this.El = null, this.M_ = null, this.vr = null;
    }
    return t.prototype.Zl = function(t) {
        ...
        return this.gd = new Ti, Promise.resolve();
    }, t.prototype.Gu = function(t, e, n) {
        // No op.
    }, t.prototype.ld = function(t) {
        // No op.
    ...
    e) {
        ...
        this._s = ue(), this.Sd = new ce(t.Be.bind(t));
    }
    ...
    t.prototype.Cd = function(t, e) {
        var n = this, r = e ? e.Fd : new fe, i = e ? e.Sd : this.Sd, o = e ? e._s : this._s, s = i, u = !1, a = this.query.je() && i.size === this.query.limit ? i.last() : null, h = this.query.Ke() && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.ut((function(t, e) {
            var c = i.get(t), f = e instanceof xt ? e : null;
    ...
    t.prototype.ir = function(t, e, n) {
        ...
        return this.bd = u, 0 !== o.length || a ? {
            snapshot: new le(this.query, t.Sd, i, o, t._s, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Ld: s
        } : {
            Ld: s
    ...
    t.prototype.$d = function(t) {
        ...
        // updating many documents.
                var e = this.vd;
        this.vd = ue(), this.Sd.forEach((function(e) {
            t.xd(e.key) && (t.vd = t.vd.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.vd.has(e) || n.push(new Si(e));
    ...
    t.prototype.qd = function() {
        return le.fs(this.query, this.Sd, this._s, 0 /* Local */ === this.bd);
    }, t;
}(), ki = /** @class */ function() {
    function t(t, e, n, r) {
        this.jr = t, this.Ud = e, this.updateFunction = n, this.zr = r, this.Qd = 5, this.oh = new tn(this.jr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.Wd = function() {
        ...
        this.oh.Ur((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = this.Ud.Sl(), (e = this.Kd(t)) && e.then((function(e) {
                        r.jr.Zr((function() {
        ...
        try {
            ...
            return !K(e) && e.catch && e.then ? e : (this.zr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !Xt(e);
        }
        return !1;
    }, t;
}(), xi = function(
...
n) {
    ...
    n, r, i) {
        ...
        /**
             ...
             */
        this.if = new Map, this.nf = new ze, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.rf = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.hf = new Map, this.af = Dn.Jo(), this.onlineState = "Unknown" /* Unknown */;
    }
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    e = i.targetId, this.Yd.nd(e), r = i.view.qd(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.j_.hc(t.xe()) ];

                  case 2:
                    return o = n.sent(), s = this.Yd.nd(o.targetId), e = o.targetId, [ 4 /*yield*/ , this._f(t, e, "current" === s) ];

                  case 3:
                    r = n.sent(), this.uf && this.Ud.listen(o), n.label = 4;

                  case 4:
                    return [ 2 /*return*/ , (this.Xd.d_([ r ]), e) ];
                }
            }));
        }));
    }, 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), o = new Di(t, e.uc), s = o.Cd(e.documents), u = de.As(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.ir(s, 
                    /* updateLimboDocuments= */ this.uf, u), this.lf(r, a.Ld), h = new xi(t, r, o), 
                    [ 2 /*return*/ , (this.Zd.set(t, h), this.tf.has(r) ? this.tf.get(r).push(t) : this.tf.set(r, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.cf("unlisten()"), e = this.Zd.get(t), (r = this.tf.get(e.targetId)).length > 1 ? [ 2 /*return*/ , (this.tf.set(e.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.Zd.delete(t)) ] : this.uf ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Yd.hd(e.targetId), this.Yd.Xl(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.j_.oc(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Yd.ad(e.targetId), i.Ud.fl(e.targetId), i.df(e.targetId);
                    })).catch(mr) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.df(e.targetId), [ 4 /*yield*/ , this.j_.oc(e.targetId, 
    ...
    t.prototype.write = function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.cf("write()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.j_.Ju(t) ];
                  ...
                  case 3:
                    ...
                    return [ 2 /*return*/ , (Re("SyncEngine", "Dropping write that cannot be persisted: " + i), 
                    void r.reject(new T(I.UNAVAILABLE, "Failed to persist write: " + i))) ];
                    throw i;

                  case 4:
                    return this.Yd.Zl(e.batchId), this.ff(e.batchId, r), [ 4 /*yield*/ , this.Tf(e.zn) ];

                  case 5:
                    return n.sent(), [ 4 /*yield*/ , this.Ud.cl() ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.cf("applyRemoteEvent()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.j_.tc(t) ];
                  ...
                  case 2:
                    ...
                    t.Ts.forEach((function(t, e) {
                        ...
                        Oe(t.Ps.size + t.Vs.size + t.gs.size <= 1), t.Ps.size > 0 ? n.Hd = !0 : t.Vs.size > 0 ? Oe(n.Hd) : t.gs.size > 0 && (Oe(n.Hd), 
                        n.Hd = !1));
                    })), [ 4 /*yield*/ , this.Tf(e, t) ];
    ...
    t.prototype.Od = function(t, e) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Yd.ud(t, "rejected", r), e = this.if.get(t), (i = e && e.key) ? (
                    // Since this query failed, we won't want to manually unlisten to it.
                    // So go ahead and remove it from bookkeeping.
                    this.sf = this.sf.remove(i), this.if.delete(t), this.If(), o = (o = new C(P.k)).nt(i, new Rt(i, x.S())), 
                    s = ue().add(i), u = new pe(x.MIN, 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new q(Ce), o, s), [ 2 /*return*/ , this.tc(u) ]) : [ 4 /*yield*/ , this.j_.oc(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.df(t, r);
                    })).catch(mr) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.cf("applySuccessfulWrite()"), e = t.batch.batchId, 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught
                    // up), so we raise user callbacks first so that they consistently happen
                    // before listen events.
                    this.wf(e, /*error=*/ null), this.Rf(e), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.j_.Do(t) ];

                  case 2:
                    return r = n.sent(), this.Yd.ed(e, "acknowledged"), [ 4 /*yield*/ , this.Tf(r) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // listen events.
                    this.wf(t, r), this.Rf(t), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.j_.Zu(t) ];

                  case 2:
                    return e = n.sent(), this.Yd.ed(t, "rejected", r), [ 4 /*yield*/ , this.Tf(e) ];
    ...
    t.prototype.Af = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Ud.J_() || xe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    [ 4 /*yield*/ , this.j_.qo() ];

                  case 1:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.hf.get(e) || []).push(t), 
                    this.hf.set(e, r), [ 2 /*return*/ ]);
                }
            }));
        }));
    }, 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.mf = function(t) {
        this.hf.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new T(I.CANCELLED, t));
            }));
        })), this.hf.clear();
    }, t.prototype.ff = function(t, e) {
        var n = this.rf[this.currentUser.s()];
        n || (n = new C(Ce)), n = n.nt(t, e), this.rf[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.wf = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Ai ? (this.nf.vn(i.key, t), this.gf(i)) : i instanceof Si ? (xe("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.sf.get(e) || (xe("SyncEngine", "New document in limbo: " + e), this.ef.push(e), 
        this.If());
    }, 
    /**
    ...
    t.prototype.If = function() {
        for (;this.ef.length > 0 && this.sf.size < this.Jd; ) {
            ...
            this.if.set(e, new Ri(t)), this.sf = this.sf.nt(t, e), this.Ud.listen(new Wt(Ot.ve(t.path).xe(), e, 2 /* LimboResolution */ , Je.Fr));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.yf = function() {
        return this.ef;
    }, t.prototype.Tf = function(t, r) {
        return e(this, void 0, void 0, (function() {
            var e, i, o, s = this;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.Zd.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var n = r && r.Ts.get(u.targetId), o = u.view.ir(t, 
                            /* updateLimboDocuments= */ s.uf, n);
                            if (s.lf(u.targetId, o.Ld), o.snapshot) {
                                s.uf && s.Yd.ud(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), e.push(o.snapshot);
                                var a = Xe.br(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return n.sent(), this.Xd.d_(e), [ 4 /*yield*/ , this.j_.ic(i) ];
        ...
        var e = this.if.get(t);
        if (e && e.Hd) return ue().add(e.key);
        var n = ue(), r = this.tf.get(t);
        if (!r) return n;
    ...
    function i(t, e, n, i, o) {
        var s = this;
        return (s = r.call(this, t, e, n, i, o) || this).j_ = t, 
        // The primary state is set to `true` or `false` immediately after Firestore
        // startup. In the interim, a client should only be considered primary if
        // `isPrimary` is true.
        s.isPrimary = void 0, s;
    }
    return t(i, r), Object.defineProperty(i.prototype, "uf", {
        get: function() {
        ...
        return this.j_.uu(!0), r.prototype.enableNetwork.call(this);
    }, i.prototype.disableNetwork = function() {
        return this.j_.uu(!1), r.prototype.disableNetwork.call(this);
    }, 
    /**
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), r = t.view.Bd(e), [ 2 /*return*/ , (this.isPrimary && this.lf(t.targetId, r.Ld), 
                    r) ];
                }
            }));
        }));
    }, i.prototype.Od = function(t, e) {
        // If we are the primary client, the online state of all clients only
        // depends on the online state of the local RemoteStore.
        this.uf && 0 /* RemoteStore */ === e && (r.prototype.Od.call(this, t, e), this.Yd.ld(t)), 
        // If we are the secondary client, we explicitly ignore the remote store's
        // online state (the local client may go offline, even though the primary
        // tab remains online) and only apply the primary tab's online state from
        // SharedClientState.
        this.uf || 1 /* SharedClientState */ !== e || r.prototype.Od.call(this, t, e);
    }, i.prototype.md = function(t, r, i) {
        return e(this, void 0, void 0, (function() {
            var e;
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return null === (e = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== r ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.Ud.cl() ];
                  ...
                  case 3:
                    ...
                    // other clients.
                    this.wf(t, i || null), this.j_.dc(t)) : Le(), n.label = 4;

                  case 4:
                    return [ 4 /*yield*/ , this.Tf(e) ];
                  ...
                  case 6:
                    ...
                    // as applicable.
                    xe("SyncEngine", "Cannot apply mutation batch with id: " + t), n.label = 7;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), e = this.Yd.Yl(), [ 4 /*yield*/ , this.vf(e.j()) ];

                  case 2:
                    for (r = n.sent(), i = 0, o = r; i < o.length; i++) s = o[i], this.Ud.listen(s);
                    return [ 3 /*break*/ , 7 ];
                  ...
                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.vf(u) ];

                  case 5:
                    return n.sent(), this.Sf(), [ 4 /*yield*/ , this.Ud.Cl(!1) ];
    ...
    }, i.prototype.Sf = function() {
        var t = this;
        this.if.forEach((function(e, n) {
            t.Ud.fl(n);
        })), this.nf.kn(), this.if = new Map, this.sf = new C(P.k);
    }, 
    /**
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    return n.sent(), [ 4 /*yield*/ , this.j_.hc(a[0].xe()) ];
                  ...
                  case 9:
                    return d = n.sent(), [ 4 /*yield*/ , this.j_.hc(d) ];

                  case 10:
                    return u = n.sent(), [ 4 /*yield*/ , this._f(this.Df(d), s, 
                    /*current=*/ !1) ];
    ...
    i.prototype.Df = function(t) {
        return new Ot(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
    }, i.prototype.yu = function() {
        return this.j_.yu();
    }, i.prototype.Pd = function(t, r, i) {
        return e(this, void 0, void 0, (function() {
            var e, o;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    xe("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];
                  ...
                  case 3:
                    return e = n.sent(), o = pe.Rs(t, "current" === r), [ 4 /*yield*/ , this.Tf(e, o) ];
                  ...
                  case 6:
                    return n.sent(), this.df(t, i), [ 3 /*break*/ , 8 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(d) {
                switch (d.label) {
                  ...
                  case 1:
                    return e < i.length ? (o = i[e], this.tf.has(o) ? (
                    // A target might have been added in a previous attempt
                    xe("SyncEngine", "Adding an already active target " + o), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , this.j_.fc(o) ]) : [ 3 /*break*/ , 6 ];
    ...
    return t.prototype.listen = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            var e, r, i, o;
            return n(this, (function(n) {
                return e = t.query, r = !1, (i = this.Nf.get(e)) && (o = i.Ff.indexOf(t)) >= 0 && (i.Ff.splice(o, 1), 
                r = 0 === i.Ff.length), r ? [ 2 /*return*/ , (this.Nf.delete(e), this.El.fl(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    return t.prototype.$f = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new le(t.query, t.docs, t.cs, e, t._s, t.fromCache, t.ls, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Od = function(t) {
        ...
        t = le.fs(t.query, t.docs, t._s, t.fromCache), this.Bf = !0, this.xf.next(t);
    }, t;
}(), Ui = /** @class */ function() {
    function t() {}
    return t.prototype.Ku = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.Oe() || n.isEqual(x.MIN) ? this.Gf(t, e) : this.Kf.Tr(t, r).next((function(o) {
            var u = i.zf(e, o);
            return (e.je() || e.Ke()) && i.kd(e.ge, u, r, n) ? i.Gf(t, e) : (De() <= s.DEBUG && xe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            i.Kf.wr(t, e, n).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.zf = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof xt && t.matches(r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.kd = function(t, e, n, r) {
        ...
        return De() <= s.DEBUG && xe("IndexFreeQueryEngine", "Using full collection scan to execute query: %s", e.toString()), 
        this.Kf.wr(t, e, x.MIN);
    }, t;
}(), Mi = /** @class */ function() {
    function t(t, e) {
        this.ur = t, this.yo = e, 
        ...
        /** The last received stream token from the server, used to acknowledge which
             ...
             * markers whose only real value is their inclusion in the next request.
             */
        this.lastStreamToken = z.xt, 
        /** An ordered mapping between documents and the mutations batch IDs. */
        this.Yf = new q(Ke.Ie);
    }
    return t.prototype.So = function(t) {
        return Ye.resolve(0 === this.ar.length);
    }, t.prototype.Do = function(t, e, n) {
        var r = e.batchId, i = this.Jf(r, "acknowledged");
        return Oe(0 === i), 
        // Verify that the batch in the queue is the one to be acknowledged.
        this.ar[i], this.lastStreamToken = n, Ye.resolve();
    }, t.prototype.Fo = function(t) {
        return Ye.resolve(this.lastStreamToken);
    }, t.prototype.No = function(t, e) {
        return this.lastStreamToken = e, Ye.resolve();
    }, t.prototype.ko = function(t, e, n, r) {
        var i = this.Hf;
        this.Hf++, this.ar.length > 0 && this.ar[this.ar.length - 1];
        var o = new Ge(i, e, n, r);
        this.ar.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Yf = this.Yf.add(new Ke(a.key, i)), this.ur.Mo(t, a.key.path.L());
        }
        return Ye.resolve(o);
    }, t.prototype.Lo = function(t, e) {
        return Ye.resolve(this.Xf(e));
    }, t.prototype.Bo = function(t, e) {
        var n = e + 1, r = this.Zf(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Ye.resolve(this.ar.length > i ? this.ar[i] : null);
    }, t.prototype.qo = function() {
        return Ye.resolve(0 === this.ar.length ? -1 : this.Hf - 1);
    }, t.prototype.Uo = function(t) {
        return Ye.resolve(this.ar.slice());
    }, t.prototype._r = function(t, e) {
        var n = this, r = new Ke(e, 0), i = new Ke(e, Number.POSITIVE_INFINITY), o = [];
        return this.Yf.Ct([ r, i ], (function(t) {
            var e = n.Xf(t.Ln);
            o.push(e);
        })), Ye.resolve(o);
    }, t.prototype.Ir = function(t, e) {
        var n = this, r = new q(Ce);
        return e.forEach((function(t) {
            var e = new Ke(t, 0), i = new Ke(t, Number.POSITIVE_INFINITY);
            n.Yf.Ct([ e, i ], (function(t) {
                r = r.add(t.Ln);
            }));
        })), Ye.resolve(this.tT(r));
    }, t.prototype.Vr = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                P.st(i) || (i = i.child(""));
        var o = new Ke(new P(i), 0), s = new q(Ce);
        ...
        var n = this;
        Oe(0 === this.Jf(e.batchId, "removed")), this.ar.shift();
        var r = this.Yf;
        return Ye.forEach(e.mutations, (function(i) {
            var o = new Ke(i.key, e.batchId);
        ...
        var n = new Ke(e, 0), r = this.Yf.Nt(n);
        return Ye.resolve(e.isEqual(r && r.key));
    }, t.prototype.zo = function(t) {
        return this.ar.length, Ye.resolve();
    }, 
    /**
    ...
    t.prototype.Zn = function(t) {
        ...
        for (var r = re(), i = new P(e.path.child("")), o = this.docs.lt(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.wt(); ) {
            var s = o.It(), u = s.key, a = s.value, h = a.Aa, c = a.readTime;
            if (!e.path.U(u.path)) break;
            c.D(n) <= 0 || h instanceof xt && e.matches(h) && (r = r.nt(h.key, h));
        }
        return Ye.resolve(r);
    }, t.prototype.sT = function(t, e) {
        return Ye.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.Ca = function(e) {
...
var ji = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.rT = new ze, this.targetCount = 0, this.hT = Dn.Yo();
    }
    return t.prototype.Xs = function(t, e) {
        ...
        return Ye.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.sa = function(t) {
        return Ye.resolve(this.nT);
    }, t.prototype.Xo = function(t) {
        return this.highestTargetId = this.hT.next(), Ye.resolve(this.highestTargetId);
    }, t.prototype.ia = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.hT = new Dn(e), this.highestTargetId = e), t.sequenceNumber > this.nT && (this.nT = t.sequenceNumber);
    }, t.prototype.na = function(t, e) {
        return this.ra(e), this.targetCount += 1, Ye.resolve();
    }, t.prototype.oa = function(t, e) {
        return this.ra(e), Ye.resolve();
    }, t.prototype.aa = function(t, e) {
        ...
        return this.iT.forEach((function(s, u) {
            ...
            i++);
        })), Ye.Kn(o).next((function() {
            return i;
        }));
    }, t.prototype.la = function(t) {
        return Ye.resolve(this.targetCount);
    }, t.prototype.da = function(t, e) {
        ...
        return this.rT.Nn(e), Ye.resolve();
    }, t.prototype.Ea = function(t, e) {
        var n = this.rT.$n(e);
        return Ye.resolve(n);
    }, t.prototype.Mn = function(t, e) {
        return Ye.resolve(this.rT.Mn(e));
    }, t;
}(), Fi = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.oT = {}, this.hu = new Je(0), this.ja = !1, this.ja = !0, this.yo = t(this), 
        this.Za = new ji(this), this.ur = new qn, this.or = new qi(this.ur, (function(t) {
            return e.yo.aT(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.oT[t.s()];
        return e || (e = new Mi(this.ur, this.yo), this.oT[t.s()] = e), e;
    }, t.prototype.vu = function() {
        return this.Za;
    }, t.prototype.Su = function() {
        return this.or;
        ...
        var r = this;
        xe("MemoryPersistence", "Starting transaction:", t);
        var i = new Gi(this.hu.next());
        ...
        return Ye.Gn(Object.values(this.oT).map((function(n) {
            return function() {
                return n.Mn(t, e);
            };
        })));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Qa = t, n;
    }
    return t(n, e), n;
}(We), Bi = /** @class */ function() {
    function t(t) {
    ...
    return t.dT = function(e) {
        ...
        return this.fT.delete(e), Ye.resolve();
    }, t.prototype.Dn = function(t, e) {
        return this.fT.add(e), Ye.resolve();
    }, t.prototype.Go = function(t, e) {
        return this.fT.add(e), Ye.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        ...
        // Remove newly orphaned documents.
                return Ye.forEach(this.fT, (function(r) {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), this.wT = this.RT(t), this.j_ = this.AT(t), this.Ud = this.mT(t), 
                    this.El = this.PT(t), this.VT = this.gT(t), this.Yd.M_ = function(t) {
                        return e.El.Od(t, 1 /* SharedClientState */);
                    }, this.Ud.El = this.El, [ 4 /*yield*/ , this.j_.start() ];

                  case 2:
                    return n.sent(), [ 4 /*yield*/ , this.Yd.start() ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.Ud.start() ];

                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.Ud.Cl(this.El.uf) ];
        ...
        return new Pi(this.El);
    }, t.prototype.RT = function(t) {
        return null;
    }, t.prototype.AT = function(t) {
        return new yr(this.persistence, new Ui, t.pT);
    }, t.prototype.IT = function(t) {
        return new Fi(Bi.dT);
    }, t.prototype.mT = function(t) {
        var e = this;
        return new yi(this.j_, t.b_, t.jr, (function(t) {
            return e.El.Od(t, 0 /* RemoteStore */);
        }), t.platform.yT());
    }, t.prototype.ET = function(t) {
        return new _i;
    }, t.prototype.PT = function(t) {
        return new Vi(this.j_, this.Ud, this.Yd, t.pT, t.Jd);
    }, t.prototype.clearPersistence = function(t) {
        throw new T(I.FAILED_PRECONDITION, "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.");
    }, t;
}(), Ki = /** @class */ function(r) {
    function i() {
    ...
    return t(i, r), i.prototype.initialize = function(t) {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    ...
                    return o.sent(), [ 4 /*yield*/ , this.persistence.ou((function(t) {
        ...
        return new vr(this.persistence, new Ui, t.pT);
    }, i.prototype.PT = function(t) {
        var e = new Li(this.j_, this.Ud, this.Yd, t.pT, t.Jd);
        return this.Yd instanceof Ni && (this.Yd.El = e), e;
    }, i.prototype.RT = function(t) {
        var e = this.persistence.yo.qh;
        return new an(e, t.jr);
    }, i.prototype.IT = function(t) {
        var e = cr.Fu(t.bT), n = t.platform.vT(t.bT.ci);
        return new cr(t.ST.synchronizeTabs, e, t.clientId, t.platform, un.kh(t.ST.cacheSizeBytes), t.jr, n, this.Yd);
    }, i.prototype.ET = function(t) {
        if (t.ST.DT && t.ST.synchronizeTabs) {
            if (!Ni.ho(t.platform)) throw new T(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var e = cr.Fu(t.bT);
            return new Ni(t.jr, t.platform, e, t.clientId, t.pT);
        }
        return new _i;
    }, i.prototype.clearPersistence = function(t) {
        var e = cr.Fu(t);
        return cr.clearPersistence(e);
    }, i;
     ...
     */
    r) {
        this.platform = t, this.bT = e, this.credentials = n, this.jr = r, this.clientId = Pe.En()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials.l((function(s) {
            if (!o) return o = !0, xe("FirestoreClient", "Initializing. user=", s.uid), n.FT(t, e, s, i).then(r.resolve, r.reject);
            n.jr.Zr((function() {
                return n.Dl(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.FT = function(t, r, i, o) {
        return e(this, void 0, void 0, (function() {
            var s, u, a, h, c = this;
            return n(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.NT(this.bT) ];

                  case 1:
                    return s = f.sent(), u = this.platform.vT(this.bT.ci), a = new li(this.jr, s, this.credentials, u), 
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.Yd = t.Yd, this.j_ = t.j_, 
    ...
    t.prototype.$T = function(t) {
        return "FirebaseError" === t.name ? t.code === I.FAILED_PRECONDITION || t.code === I.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || 
    ...
    t.prototype.CT = function() {
        if (this.jr._h) throw new T(I.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.Dl = function(t) {
        return this.jr.Rh(), xe("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.El.Dl(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return this.CT(), this.jr.enqueue((function() {
            ...
            throw new T(I.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)");
        }));
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), r = new Di(t, e.uc), i = r.Cd(e.documents), [ 2 /*return*/ , r.ir(i, 
...
var Wi = /** @class */ function() {
    ...
    return t.prototype.UT = function(t) {
        switch (X(t)) {
          ...
          case 6 /* BlobValue */ :
            return new qr(ot(t.bytesValue));

          case 7 /* RefValue */ :
            return this.jT(t.referenceValue);

          case 8 /* GeoPointValue */ :
            return new Hr(t.geoPointValue.latitude, t.geoPointValue.longitude);
        ...
        var e = rt(t), n = new k(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.jT = function(t) {
        var e = V.G(t);
        Oe(_e(e));
        var n = new je(e.get(1), e.get(3)), r = new P(e.M(5));
        return n.isEqual(this.firestore.zT) || 
        // TODO(b/64130202): Somehow support foreign references.
        Re("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.firestore.zT.projectId + "/" + this.firestore.zT.database + ") instead."), 
        new eo(r, this.firestore, this.converter);
    }, t;
}(), Hi = un.Lh, Xi = /** @class */ function() {
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new T(I.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Nr("settings", "non-empty string", "host", t.host), this.host = t.host, _r("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (Rr("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling" ]), 
        _r("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        _r("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), 
        ...
        _r("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = un.xh; else {
            if (t.cacheSizeBytes !== Hi && t.cacheSizeBytes < un.Oh) throw new T(I.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + un.Oh);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        _r("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new zi), this.HT = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.YT = new nn, this.INTERNAL = {
            delete: function() {
            ...
            var u = r;
            this.HT = u, this.zT = t.ZT(u), this.tE = u.name, this.eE = new A(i);
        } else {
            var a = r;
            if (!a.projectId) throw new T(I.INVALID_ARGUMENT, "Must provide projectId");
            this.zT = new je(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.tE = "[DEFAULT]", this.eE = new _;
        }
        this.sE = o, this.iE = new Xi({}), this.nE = this.rE(this.zT);
    }
    return t.prototype.settings = function(t) {
        Er("Firestore.settings", arguments, 1), Ir("Firestore.settings", "object", 1, t);
        var e = new Xi(t);
        if (this.XT && !this.iE.isEqual(e)) throw new T(I.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
            ...
            switch (t.type) {
              case "gapi":
                ...
                // Make sure this really is a Gapi client.
                                return Oe(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), 
                new D(e, t.V || "0");
              ...
              default:
                throw new T(I.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        ...
        var e, n;
        if (this.XT) throw new T(I.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                if (void 0 !== this.XT && !this.XT.MT) throw new T(I.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new $e, [ 2 /*return*/ , (this.YT.lh((function() {
                    return e(r, void 0, void 0, (function() {
                        var e, r;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), e = this.aE(), [ 4 /*yield*/ , this.sE.clearPersistence(e) ];
        ...
        if (this.JT(), Zi(t)) return this.cE(t);
        Ir("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return this.cE(e);
        ...
        return new qe(this.zT, this.tE, this.iE.host, this.iE.ssl, this.iE.forceLongPolling);
    }, t.prototype.oE = function(t, e) {
        var n = this.aE();
        return this.XT = new Yi(Ae.Lt(), n, this.eE, this.YT), this.XT.start(t, e);
    }, t.prototype.rE = function(t) {
        var e = Ae.Lt().vT(t);
        return new ri(e, (function(e) {
            if (e instanceof eo) {
                var n = t, r = e.firestore.zT;
                if (!r.isEqual(n)) throw new T(I.INVALID_ARGUMENT, "Document reference is for database " + r.projectId + "/" + r.database + " but should be for database " + n.projectId + "/" + n.database);
                return new ni(t, e._E);
            }
            return e;
        }));
    }, t.ZT = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new T(I.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
        var e, n = t.options.projectId;
        // Export the classes with a private constructor (it will fail if invoked
        // at runtime). Note that this still allows instanceof checks.
        // We're treating the variables as class names, so disable checking for lower
        // case variable names.
                if (!n || "string" != typeof n) throw new T(I.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new je(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.HT) throw new T(I.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.HT;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return Er("Firestore.collection", arguments, 1), Ir("Firestore.collection", "non-empty string", 1, t), 
        this.JT(), new uo(V.G(t), this);
    }, t.prototype.doc = function(t) {
        return Er("Firestore.doc", arguments, 1), Ir("Firestore.doc", "non-empty string", 1, t), 
        this.JT(), eo.lE(V.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (Er("Firestore.collectionGroup", arguments, 1), Ir("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new T(I.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.JT(), new oo(new Ot(V.H, t), this);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return Er("Firestore.runTransaction", arguments, 1), Ir("Firestore.runTransaction", "function", 1, t), 
        this.JT().transaction((function(n) {
            return t(new $i(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.JT(), new to(this);
        ...
        switch (Er("Firestore.setLogLevel", arguments, 1), Ir("Firestore.setLogLevel", "non-empty string", 1, t), 
        t) {
          case "debug":
            ke(s.DEBUG);
            break;
          ...
          default:
            throw new T(I.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    ...
    return t.prototype.get = function(t) {
        var e = this;
        Er("Transaction.get", arguments, 1);
        var n = fo("Transaction.get", t, this.fE);
        return this.TE.p_([ n._E ]).then((function(t) {
            if (!t || 1 !== t.length) return Le();
            var r = t[0];
            if (r instanceof Rt) return new ro(e.fE, n._E, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.EE);
            if (r instanceof xt) return new ro(e.fE, n._E, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.EE);
            throw Le();
        }));
    }, t.prototype.set = function(t, e, n) {
        br("Transaction.set", arguments, 2, 3);
        var r = fo("Transaction.set", t, this.fE);
        n = ao("Transaction.set", n);
        var i = po(r.EE, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.fE.nE.Mc(s, o, n.mergeFields) : this.fE.nE.kc(s, o);
        return this.TE.set(r._E, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof Fr ? (wr("Transaction.update", arguments, 3), 
        r = fo("Transaction.update", t, this.fE), i = this.fE.nE.Bc("Transaction.update", e, n, o)) : (Er("Transaction.update", arguments, 2), 
        r = fo("Transaction.update", t, this.fE), i = this.fE.nE.Lc("Transaction.update", e)), 
        this.TE.update(r._E, i), this;
    }, t.prototype.delete = function(t) {
        Er("Transaction.delete", arguments, 1);
        var e = fo("Transaction.delete", t, this.fE);
    ...
    return t.prototype.set = function(t, e, n) {
        br("WriteBatch.set", arguments, 2, 3), this.RE();
        var r = fo("WriteBatch.set", t, this.fE);
        n = ao("WriteBatch.set", n);
        var i = po(r.EE, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.fE.nE.Mc(s, o, n.mergeFields) : this.fE.nE.kc(s, o);
        return this.IE = this.IE.concat(u.gc(r._E, wt.NONE)), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.RE(), "string" == typeof e || e instanceof Fr ? (wr("WriteBatch.update", arguments, 3), 
        r = fo("WriteBatch.update", t, this.fE), i = this.fE.nE.Bc("WriteBatch.update", e, n, o)) : (Er("WriteBatch.update", arguments, 2), 
        r = fo("WriteBatch.update", t, this.fE), i = this.fE.nE.Lc("WriteBatch.update", e)), 
        this.IE = this.IE.concat(i.gc(r._E, wt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        Er("WriteBatch.delete", arguments, 1), this.RE();
        var e = fo("WriteBatch.delete", t, this.fE);
        return this.IE = this.IE.concat(new _t(e._E, wt.NONE)), this;
    }, t.prototype.commit = function() {
        return this.RE(), this.wE = !0, this.IE.length > 0 ? this.fE.JT().write(this.IE) : Promise.resolve();
    }, t.prototype.RE = function() {
        if (this.wE) throw new T(I.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), eo = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.lE = function(e, n, r) {
        if (e.length % 2 != 0) throw new T(I.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.K() + " has " + e.length);
        return new t(new P(e), n, r);
        ...
        get: function() {
            return new uo(this._E.path.L(), this.firestore, this.EE);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (Er("DocumentReference.collection", arguments, 1), Ir("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new T(I.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = V.G(t);
        return new uo(this._E.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Vr("isEqual", "DocumentReference", 1, e);
        return this.firestore === e.firestore && this._E.isEqual(e._E) && this.EE === e.EE;
    }, t.prototype.set = function(t, e) {
        br("DocumentReference.set", arguments, 1, 2), e = ao("DocumentReference.set", e);
        var n = po(this.EE, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.nE.Mc(i, r, e.mergeFields) : this.firestore.nE.kc(i, r);
        return this.XT.write(o.gc(this._E, wt.NONE));
    }, t.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof Fr ? (wr("DocumentReference.update", arguments, 2), 
        n = this.firestore.nE.Bc("DocumentReference.update", t, e, r)) : (Er("DocumentReference.update", arguments, 1), 
        n = this.firestore.nE.Lc("DocumentReference.update", t)), this.XT.write(n.gc(this._E, wt.exists(!0)));
    }, t.prototype.delete = function() {
        return Er("DocumentReference.delete", arguments, 0), this.XT.write([ new _t(this._E, wt.NONE) ]);
    }, t.prototype.onSnapshot = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        br("DocumentReference.onSnapshot", arguments, 1, 4);
        var n, r = {
            includeMetadataChanges: !1
        }, i = 0;
        "object" != typeof t[i] || Zi(t[i]) || (Rr("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        _r("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return Zi(t[i]) ? n = t[i] : (Ir("DocumentReference.onSnapshot", "function", i, t[i]), 
        Tr("DocumentReference.onSnapshot", "function", i + 1, t[i + 1]), Tr("DocumentReference.onSnapshot", "function", i + 2, t[i + 2]), 
        n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new Qi({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new ro(n.firestore, n._E, r, t.fromCache, t.hasPendingWrites, n.EE));
                }
            },
            error: r
        }), o = this.XT.listen(Ot.ve(this._E.path), i, t);
        return function() {
            i.BT(), n.XT.fl(o);
        };
    }, t.prototype.get = function(t) {
        var e = this;
        return br("DocumentReference.get", arguments, 0, 1), co("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.JT().LT(e._E).then((function(t) {
                n(new ro(e.firestore, e._E, t, 
                /*fromCache=*/ !0, t instanceof xt && t.te, e.EE));
            }), r) : e.mE(n, r, t);
        }));
        ...
        var r = this.AE({
            ...
            next: function(i) {
                ...
                e(new T(I.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new T(I.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
    ...
    return t.prototype.data = function(t) {
        if (br("DocumentSnapshot.data", arguments, 0, 1), t = ho("DocumentSnapshot.data", t), 
        this.PE) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.EE) {
                var e = new io(this.fE, this._E, this.PE, this.VE, this.gE);
                return this.EE.fromFirestore(e, t);
            }
            return new Wi(this.fE, this.fE.dE(), t.serverTimestamps, 
            /* converter= */ void 0).UT(this.PE.Re());
        }
    }, t.prototype.get = function(t, e) {
        if (br("DocumentSnapshot.get", arguments, 1, 2), e = ho("DocumentSnapshot.get", e), 
        this.PE) {
            var n = this.PE.data().field(si("DocumentSnapshot.get", t));
            if (null !== n) return new Wi(this.fE, this.fE.dE(), e.serverTimestamps, this.EE).UT(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this._E.path.B();
        ...
        get: function() {
            return new eo(this._E, this.fE, this.EE);
        },
        enumerable: !0,
        configurable: !0
        ...
        get: function() {
            return new no(this.gE, this.VE);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Vr("isEqual", "DocumentSnapshot", 1, e);
    ...
    return t.prototype.where = function(e, n, r) {
        var i;
        Er("Query.where", arguments, 3), xr("Query.where", 3, r), function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new T(I.INVALID_ARGUMENT, "Invalid value " + kr(r) + " provided to function Query.where() for its " + Or(2) + " argument. Acceptable values: " + e.join(", "));
        }(0, [ "<", "<=", "==", ">=", ">", "array-contains", "in", "array-contains-any" ], 0, n);
        var o = si("Query.where", e), s = Pt.G(n);
        if (o.J()) {
            if (s === Pt.ARRAY_CONTAINS || s === Pt.ARRAY_CONTAINS_ANY) throw new T(I.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + s.toString() + "' queries on FieldPath.documentId().");
            if (s === Pt.IN) {
                this.yE(r, s);
        ...
        } else s !== Pt.IN && s !== Pt.ARRAY_CONTAINS_ANY || this.yE(r, s), i = this.firestore.nE.qc("Query.where", r, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ s === Pt.IN);
        var f = Ct.create(o, s, i);
        return this.vE(f), new t(this.pE.Ce(f), this.firestore, this.EE);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (br("Query.orderBy", arguments, 1, 2), Tr("Query.orderBy", "non-empty string", 2, n), 
        void 0 === n || "asc" === n) r = Gt.ASCENDING; else {
            if ("desc" !== n) throw new T(I.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = Gt.DESCENDING;
        }
        if (null !== this.pE.startAt) throw new T(I.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.pE.endAt) throw new T(I.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = si("Query.orderBy", e), o = new Yt(i, r);
        return this.SE(o), new t(this.pE.Fe(o), this.firestore, this.EE);
    }, t.prototype.limit = function(e) {
        return Er("Query.limit", arguments, 1), Ir("Query.limit", "number", 1, e), Lr("Query.limit", 1, e), 
        new t(this.pE.Ne(e), this.firestore, this.EE);
    }, t.prototype.limitToLast = function(e) {
        return Er("Query.limitToLast", arguments, 1), Ir("Query.limitToLast", "number", 1, e), 
        Lr("Query.limitToLast", 1, e), new t(this.pE.ke(e), this.firestore, this.EE);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        wr("Query.startAt", arguments, 1);
        var i = this.DE("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(this.pE.$e(i), this.firestore, this.EE);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        wr("Query.startAfter", arguments, 1);
        var i = this.DE("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(this.pE.$e(i), this.firestore, this.EE);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        wr("Query.endBefore", arguments, 1);
        var i = this.DE("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(this.pE.Me(i), this.firestore, this.EE);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        wr("Query.endAt", arguments, 1);
        var i = this.DE("Query.endAt", e, n, 
        /*before=*/ !1);
        return new t(this.pE.Me(i), this.firestore, this.EE);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Vr("isEqual", "Query", 1, e);
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.DE = function(t, e, n, r) {
        if (xr(t, 1, e), e instanceof ro) {
            if (n.length > 0) throw new T(I.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
            if (!i.exists) throw new T(I.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
    ...
    t.prototype.CE = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.pE.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.J()) n.push(st(this.firestore.zT, t.key)); else {
                var s = t.field(o.field);
                if (Z(s)) throw new T(I.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.K();
                    throw new T(I.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.FE = function(t, e, n) {
        ...
        var r = this.pE.Ve;
        if (e.length > r.length) throw new T(I.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.J()) {
                if ("string" != typeof s) throw new T(I.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.pE.He() && -1 !== s.indexOf("/")) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.pE.path.child(V.G(s));
                if (!P.st(u)) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new P(u);
                i.push(st(this.firestore.zT, a));
            } else {
                var h = this.firestore.nE.qc(t, s);
                i.push(h);
            }
        }
        return new Kt(i, n);
        ...
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        br("Query.onSnapshot", arguments, 1, 4);
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || Zi(t[i]) || (Rr("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        _r("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), Zi(t[i]) ? n = t[i] : (Ir("Query.onSnapshot", "function", i, t[i]), Tr("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        Tr("Query.onSnapshot", "function", i + 2, t[i + 2]), n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new Qi({
            next: function(t) {
                e.next && e.next(new so(n.firestore, n.pE, t, n.EE));
            },
            error: r
        ...
        if (t.Ke() && 0 === t.Ve.length) throw new T(I.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        return br("Query.get", arguments, 0, 1), co("Query.get", t), this.NE(this.pE), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.JT().OT(e.pE).then((function(t) {
                n(new so(e.firestore, e.pE, t, e.EE));
            }), r) : e.mE(n, r, t);
        }));
    }, t.prototype.mE = function(t, e, n) {
        var r = this.AE({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new T(I.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.bE = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.pE.He() && -1 !== t.indexOf("/")) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.pE.path.child(V.G(t));
            if (!P.st(e)) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return st(this.firestore.zT, new P(e));
        }
        if (t instanceof eo) {
            var n = t;
            return st(this.firestore.zT, n._E);
        }
        throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + kr(t) + ".");
    }, 
    /**
     ...
     */
    t.prototype.yE = function(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new T(I.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
        if (t.length > 10) throw new T(I.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
        if (t.indexOf(null) >= 0) throw new T(I.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new T(I.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
    }, t.prototype.vE = function(t) {
        if (t instanceof Ct) {
            var e = [ Pt.ARRAY_CONTAINS, Pt.ARRAY_CONTAINS_ANY ], n = [ Pt.IN, Pt.ARRAY_CONTAINS_ANY ], r = e.indexOf(t.op) >= 0, i = n.indexOf(t.op) >= 0;
            if (t.Ge()) {
                var o = this.pE.Se();
                if (null !== o && !o.isEqual(t.field)) throw new T(I.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.pE.De();
                ...
                throw u === t.op ? new T(I.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new T(I.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new T(I.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}(), so = /** @class */ function() {
    function t(t, e, n, r) {
        this.fE = t, this.$E = e, this.ME = n, this.EE = r, this.LE = null, this.OE = null, 
        this.metadata = new no(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        br("QuerySnapshot.forEach", arguments, 1, 2), Ir("QuerySnapshot.forEach", "function", 1, t), 
        this.ME.docs.forEach((function(r) {
            t.call(e, n.xE(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new oo(this.$E, this.fE, this.EE);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (Rr("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), _r("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.ME.ds) throw new T(I.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e, n, r) {
            if (n.cs.q()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new io(t, e.doc.key, e.doc, n.fromCache, n._s.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new io(t, e.doc.key, e.doc, n.fromCache, n._s.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Vr("isEqual", "QuerySnapshot", 1, e);
        return this.fE === e.fE && this.$E.isEqual(e.$E) && this.ME.isEqual(e.ME) && this.EE === e.EE;
    }, t.prototype.xE = function(t) {
        return new io(this.fE, t.key, t, this.metadata.fromCache, this.ME._s.has(t.key), this.EE);
    }, t;
}(), uo = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Ot.ve(t), n, r) || this).BE = t, t.length % 2 != 1) throw new T(I.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.K() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.q() ? null : new eo(new P(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (br("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = Pe.En()), Ir("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new T(I.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = V.G(t);
        return eo.lE(this.pE.path.child(e), this.firestore, this.EE);
    }, n.prototype.add = function(t) {
        Er("CollectionReference.add", arguments, 1), Ir("CollectionReference.add", "object", 1, this.EE ? this.EE.toFirestore(t) : t);
        var e = this.doc();
...
function ao(t, e) {
    ...
    if (Rr(t, e, [ "merge", "mergeFields" ]), _r(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + kr(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + kr(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof Fr;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new T(I.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}

function ho(t, e) {
    return void 0 === e ? {} : (Rr(t, e, [ "serverTimestamps" ]), Ar(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function co(t, e) {
    Tr(t, "object", 1, e), e && (Rr(t, e, [ "source" ]), Ar(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}

function fo(t, e, n) {
    if (e instanceof eo) {
        if (e.firestore !== n) throw new T(I.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
    throw Vr(t, "DocumentReference", 1, e);
}
...
var yo = Cr(Ji, "Use firebase.firestore() instead."), vo = Cr($i, "Use firebase.firestore().runTransaction() instead."), mo = Cr(to, "Use firebase.firestore().batch() instead."), go = Cr(eo, "Use firebase.firestore().doc() instead."), Eo = Cr(ro), wo = Cr(io), bo = Cr(oo), Io = Cr(so), To = Cr(uo, "Use firebase.firestore().collection() instead."), No = {
    Firestore: yo,
    GeoPoint: Hr,
    Timestamp: k,
    Blob: jr,
    ...
    return t.prototype.Y_ = function(t) {
        ...
        xe("ConnectivityMonitor", "Network connectivity changed: AVAILABLE");
        for (var t = 0, e = this.jE; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    }, t.prototype.WE = function() {
        xe("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (var t = 0, e = this.jE; t < e.length; t++) {
            (0, e[t])(1 /* UNAVAILABLE */);
        }
    }, 
    ...
    Commit: "commit"
}, ko = "gl-js/ fire/" + w, xo = /** @class */ function() {
    function t(t) {
        this.ci = t.ci;
     ...
     */    return t.prototype.sI = function(t, e) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      case m.NO_ERROR:
                        ...
                        xe("Connection", "XHR received:", JSON.stringify(e)), o(e);
                        break;

                      case m.TIMEOUT:
                        xe("Connection", 'RPC "' + t + '" timed out'), s(new T(I.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case m.HTTP_ERROR:
                        var n = u.getStatus();
                        if (xe("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", u.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new T(i, r.message));
                            } else s(new T(I.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        xe("Connection", 'RPC "' + t + '" failed'), s(new T(I.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.eI, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = g(), i = {
        ...
        this.sI(i.initMessageHeaders, e), 
        ...
        var o = n.join("");
        xe("Connection", "Creating WebChannel: " + o + " " + i);
        var s = r.createWebChannel(o, i), u = !1, d = !1, y = new So({
            GE: function(t) {
                d ? xe("Connection", "Not sending because WebChannel is closed:", t) : (u || (xe("Connection", "Opening WebChannel transport."), 
                s.open(), u = !0), xe("Connection", "WebChannel sending:", t), s.send(t));
            },
            zE: function() {
                return s.close();
            }
        ...
        return v(E.EventType.OPEN, (function() {
            d || xe("Connection", "WebChannel transport opened.");
        })), v(E.EventType.CLOSE, (function() {
            d || (d = !0, xe("Connection", "WebChannel transport closed"), y.ZE());
        })), v(E.EventType.ERROR, (function(t) {
            d || (d = !0, xe("Connection", "WebChannel transport errored:", t), y.ZE(new T(I.UNAVAILABLE, "The operation could not be completed")));
        })), v(E.EventType.MESSAGE, (function(t) {
            var e;
            if (!d) {
                var n = t.data[0];
                Oe(!!n);
                ...
                if (i) {
                    xe("Connection", "WebChannel received error:", i);
                    ...
                    void 0 === u && (u = I.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    d = !0, y.ZE(new T(u, a)), s.close();
                } else xe("Connection", "WebChannel received:", n), y.tI(n);
            }
        })), setTimeout((function() {
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new d("firestore", (function(t) {
            return function(t, e) {
                return new Ji(t, e, new Ki);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, No)));
...
Ae.fn(new (/** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "document", {
        ...
        return Promise.resolve(new xo(t));
    }, t.prototype.yT = function() {
        return Ao.ho() ? new Ao : new _o;
...
export { Ro as __PRIVATE_registerFirestore };
