...
export declare class SubchannelPool {
     ...
     */
    getOrCreateSubchannel(channelTarget: string, subchannelTarget: SubchannelAddress, channelArguments: ChannelOptions, channelCredentials: ChannelCredentials): Subchannel;
}
/**
