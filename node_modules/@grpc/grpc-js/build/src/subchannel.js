...
class Subchannel {
    ...
    createSession(proxyConnectionResult) {
         ...
         */
        const session = http2.connect(addressScheme +
            resolver_1.getDefaultAuthority((_a = proxyConnectionResult.realTarget) !== null && _a !== void 0 ? _a : this.channelTarget), connectionOptions);
    ...
    startConnectingInternal() {
        http_proxy_1.getProxiedConnection(this.subchannelAddress, this.options).then((result) => {
