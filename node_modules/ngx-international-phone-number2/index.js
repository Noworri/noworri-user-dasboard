...
var PhoneNumberComponent = /** @class */ (function () {
    ...
    PhoneNumberComponent.propDecorators = {
        ...
        countryCodeSpace: [{ type: Input }],
        noUSCountryCode: [{ type: Input }],
        autoTouch: [{ type: Input }],
...
var PhoneMaskCursorProcessorDirective = /** @class */ (function () {
    ...
    PhoneMaskCursorProcessorDirective.propDecorators = {
        keypress: [{ type: HostListener, args: ['click', ['$event', '$event.target'],] }]
    };
...
export { InternationalPhoneNumber2Module, CountryService, CountryPipe, PhoneNumberComponent, PhoneMaskCursorProcessorDirective };
