...
function (_Value) {
  ...
  function Gradient() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "directions", {
      top: 'bottom',
      left: 'right',
      bottom: 'top',
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "oldDirections", {
