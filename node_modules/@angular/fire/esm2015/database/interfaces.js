...
if (false) {
     ...
     * @return {?}
     */
    AngularFireList.prototype.valueChanges = function (events, options) { };
    /**
     * @template K
     * @param {?=} events
     * @param {?=} options
