...
/** @nocollapse */ AngularFireAuth.ɵprov = defineInjectable({ factory: function AngularFireAuth_Factory() { return new AngularFireAuth(inject(FIREBASE_OPTIONS), inject(FIREBASE_APP_NAME, 8), inject(PLATFORM_ID), inject(NgZone), inject(USE_EMULATOR, 8), inject(SETTINGS, 8), inject(TENANT_ID, 8), inject(LANGUAGE_CODE, 8), inject(USE_DEVICE_LANGUAGE, 8), inject(PERSISTENCE, 8)); }, token: AngularFireAuth, providedIn: "any" });
if (false) {
    /**
