import { InjectionToken, Injectable, Inject, Optional, PLATFORM_ID, NgZone, defineInjectable, inject, NgModule } from '@angular/core';
...
/** @nocollapse */ AngularFirestore.ɵprov = defineInjectable({ factory: function AngularFirestore_Factory() { return new AngularFirestore(inject(FIREBASE_OPTIONS), inject(FIREBASE_APP_NAME, 8), inject(ENABLE_PERSISTENCE, 8), inject(SETTINGS, 8), inject(PLATFORM_ID), inject(NgZone), inject(PERSISTENCE_SETTINGS, 8), inject(USE_EMULATOR, 8), inject(USE_EMULATOR$1, 8)); }, token: AngularFirestore, providedIn: "any" });
if (false) {
    /** @type {?} */
