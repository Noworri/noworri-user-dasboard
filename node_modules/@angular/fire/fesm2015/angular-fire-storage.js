...
import { InjectionToken, Injectable, Inject, Optional, PLATFORM_ID, NgZone, defineInjectable, inject, Pipe, ChangeDetectorRef, NgModule } from '@angular/core';
...
/** @nocollapse */ AngularFireStorage.ɵprov = defineInjectable({ factory: function AngularFireStorage_Factory() { return new AngularFireStorage(inject(FIREBASE_OPTIONS), inject(FIREBASE_APP_NAME, 8), inject(BUCKET, 8), inject(PLATFORM_ID), inject(NgZone), inject(MAX_UPLOAD_RETRY_TIME, 8), inject(MAX_OPERATION_RETRY_TIME, 8)); }, token: AngularFireStorage, providedIn: "any" });
if (false) {
    /** @type {?} */
