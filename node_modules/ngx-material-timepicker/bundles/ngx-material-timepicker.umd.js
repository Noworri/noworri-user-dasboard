(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('luxon'), require('@angular/platform-browser'), require('@angular/common'), require('@angular/forms'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define('ngx-material-timepicker', ['exports', 'luxon', '@angular/platform-browser', '@angular/common', '@angular/forms', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/animations'], factory) :
    (factory((global['ngx-material-timepicker'] = {}),global.luxon,global.ng.platformBrowser,global.ng.common,global.ng.forms,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.animations));
}(this, (function (exports,luxon,platformBrowser,common,forms,rxjs,operators,i0,animations) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxMaterialTimepickerComponent = /** @class */ (function () {
        function NgxMaterialTimepickerComponent(timepickerService, eventService) {
            ...
            this.subscriptions = [];
            this.subscriptions.push(rxjs.merge(this.eventService.backdropClick, this.eventService.keydownEvent.pipe(operators.filter(( /**
             * @param {?} e
             * @return {?}
