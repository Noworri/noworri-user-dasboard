(function (global, factory) {
	...
	(factory((global['amazing-time-picker'] = {}),global.ng.core,global.ng.common,global.ng.forms));
...
var AtpCoreService = (function () {
    ...
    AtpCoreService.prototype.StringToTime = function (time) {
        var _d = time.split(':'), h = _d[0], m = _d[1];
...
var TimePickerComponent = (function () {
    ...
    TimePickerComponent.prototype.setNewRotation = function () {
        var /** @type {?} */ targetDegree = ((this.time.minute / 60) * 360) + 360;
        var /** @type {?} */ targetDegree2 = targetDegree * 2;
        var /** @type {?} */ diff1 = Math.abs(this.degree - targetDegree);
        var /** @type {?} */ diff2 = Math.abs(this.degree - targetDegree2);
        if (diff1 < diff2) {
...
var AtpDirective = (function () {
    ...
    AtpDirective.prototype.onClick = function (e) {
        ...
        var /** @type {?} */ animation = ele.getAttribute('animation');
        var /** @type {?} */ preference = ele.getAttribute('preference') || null;
        var /** @type {?} */ onlyHour = ele.getAttribute('onlyHour') === 'true';
        var /** @type {?} */ onlyMinute = ele.getAttribute('onlyMinute') === 'true';
        var /** @type {?} */ onlyAM = ele.getAttribute('onlyAM') === 'true';
        var /** @type {?} */ onlyPM = ele.getAttribute('onlyPM') === 'true';
