...
@Component({
  selector: 'app-escrow-services-buyers-step1',
  templateUrl: './escrow-services-buyers-step1.component.html',
  styleUrls: ['./escrow-services-buyers-step1.component.scss']
})
export class EscrowServicesBuyersStep1Component implements OnInit {
 ...
 fescrowStep1(F: NgForm, form) {
   ...
   if (
    ...
    this.router.navigate(['/escrowservicesbuyersstep2']);
   }
   this.router.navigate(['/escrowservicesbuyersstep2']);
 }
