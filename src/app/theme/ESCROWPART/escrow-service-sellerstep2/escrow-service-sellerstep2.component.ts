...
@Component({
  selector: 'app-escrow-service-sellerstep2',
  templateUrl: './escrow-service-sellerstep2.component.html',
  styleUrls: ['./escrow-service-sellerstep2.component.scss']
})
export class EscrowServiceSellerstep2Component implements OnInit {
  CreditCard: boolean;
  Mobilewalet: boolean;
  Form: FormGroup;
  price: number;
