...
@Component({
  selector: 'app-escrow-service-sellerstep1',
  templateUrl: './escrow-service-sellerstep1.component.html',
  styleUrls: ['./escrow-service-sellerstep1.component.scss']
})
export class EscrowServiceSellerstep1Component implements OnInit {
  ...
  fescrowStep1(F: NgForm, telInputform) {
    ...
    if (this.acceptdeadLineHoursOrDay == true &&
      ...
      setTimeout(() => {
        ...
        this.router.navigate(['/escrowservicesellerstep2']);
      }, 5000);
    } else {
      this.isValidating = false;
    }
