...
@Component({
  selector: 'app-escrow-service-buyerstep2',
  templateUrl: './escrow-service-buyerstep2.component.html',
  styleUrls: ['./escrow-service-buyerstep2.component.scss']
})
export class EscrowServiceBuyerstep2Component implements OnInit {
  CreditCard: boolean;
  Mobilewalet: boolean;
  Form: FormGroup;
  price: number;
