...
export class Step3Component implements OnInit {
  ...
  onSaveOwnerInformation() {
    ...
    if (
      ...
      this.bsnessOwnerInputStatus.identification_document === 'form-control is-valid' &&
      this.bsnessOwnerInputStatus.is_legally_registered === 'form-control is-valid' &&
      this.bsnessOwnerInputStatus.business_legal_name === 'form-control is-valid' &&
  ...
  getAllCreatBusinessData() {
    ...
    let businessAdrssInfo = JSON.parse(sessionStorage.getItem('businessAdressInfo'))
  ...
  getBusinessOwnerInformation() {
    ...
    this.businessOwnerInformation = {
      ...
      identification_document: this.bsnessOwnerForm.get('identification_document').value,
      identification_documentUpload: this.idDocumentFile,
      is_legally_registered: this.isLegallyRegistered,
      business_legal_name: this.bsnessOwnerForm.get('business_legal_name').value,
  ...
  processingData(businessOwnerInformation) {
    ...
    this.bsnessOwnerInputStatus.dob = businessOwnerInformation.dob ? 'form-control is-valid' : 'form-control is-invalid'
    this.bsnessOwnerInputStatus.nationality = businessOwnerInformation.nationality ? 'form-control is-valid' : 'form-control is-invalid'
    this.bsnessOwnerInputStatus.owner_adresse = businessOwnerInformation.owner_adresse ? 'form-control is-valid' : 'form-control is-invalid'
    this.bsnessOwnerInputStatus.is_legally_registered = businessOwnerInformation.is_legally_registered ? 'form-control is-valid' : 'form-control is-invalid'
    this.bsnessOwnerInputStatus.business_legal_name = businessOwnerInformation.business_legal_name ? 'form-control is-valid' : 'form-control is-invalid'
    this.bsnessOwnerInputStatus.identification_document = businessOwnerInformation.identification_document ? 'form-control is-valid' : 'form-control is-invalid'
    this.bsnessOwnerInputStatus.company_documents = this.companyDocuments ? 'form-control is-valid' : 'form-control is-invalid'
    this.isIdUpload = this.businessOwnerInformation['identification_documentUpload'] ? false : true
    this.isCdUpload = this.businessOwnerInformation['company_documentUpload'] ? false : true
  }
}
