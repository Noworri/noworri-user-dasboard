...
export class Step1Component implements OnInit {
  ...
  saveBusnessInformation() {
    sessionStorage.setItem(
      businessInformation,
      JSON.stringify(this.businessInformation)
    );
  }
  ...
  processingData(businessInformation) {
    this.bsnessInfoInputStatus.trading_name = businessInformation.trading_name
      ? "form-control is-valid"
      : "form-control is-invalid";
    this.bsnessInfoInputStatus.business_name = businessInformation.business_name
      ? "form-control is-valid"
      : "form-control is-invalid";
    this.bsnessInfoInputStatus.description = businessInformation.description
      ? "form-control is-valid"
      : "form-control is-invalid";
    this.bsnessInfoInputStatus.industry = businessInformation.industry
      ? "form-control is-valid"
      : "form-control is-invalid";
    this.bsnessInfoInputStatus.business_email = businessInformation.business_email
      ? "form-control is-valid"
      : "form-control is-invalid";
