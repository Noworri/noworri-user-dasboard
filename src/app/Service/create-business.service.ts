...
export class CreateBusinessService {
  ...
  createNewBusiness(allData) {
    ...
    params = params.append('business_legal_name', allData['business_legal_name']);
    ...
    params = params.append('company_document_path', allData['company_documentUpload']);
    ...
    params = params.append('is_legally_registered', allData['is_legally_registered']);
